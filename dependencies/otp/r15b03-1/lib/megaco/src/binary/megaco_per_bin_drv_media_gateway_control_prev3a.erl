...
%% Purpose: encoder and decoder to the types in mod megaco_per_bin_drv_media_gateway_control_prev3a

-module('megaco_per_bin_drv_media_gateway_control_prev3a').
-include("megaco_per_bin_drv_media_gateway_control_prev3a.hrl").
...
%% attribute number 1 with type Externaltypereference971megaco_per_bin_drv_media_gateway_control_prev3aNonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference966megaco_per_bin_drv_media_gateway_control_prev3aValue
'enc_Value'(Tmpval2)
end].
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3aMId
'enc_MId'(Tmpval1)
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3aServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference930megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference931megaco_per_bin_drv_media_gateway_control_prev3aTimeNotation
...
%% attribute number 2 with type Externaltypereference890megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeAddress
'enc_ServiceChangeAddress'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 4 with type Externaltypereference892megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval5)
end,

%% attribute number 5 with type Externaltypereference893megaco_per_bin_drv_media_gateway_control_prev3aValue
...
%% attribute number 7 with type Externaltypereference906megaco_per_bin_drv_media_gateway_control_prev3aMId
'enc_MId'(Tmpval7)
end,
...
%% attribute number 8 with type Externaltypereference907megaco_per_bin_drv_media_gateway_control_prev3aTimeNotation
...
%% attribute number 9 with type Externaltypereference908megaco_per_bin_drv_media_gateway_control_prev3aNonStandardData
...
%% attribute number 10 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3aAuditDescriptor
...
%% attribute number 2 with type Externaltypereference867megaco_per_bin_drv_media_gateway_control_prev3aDigitMapValue
...
%% attribute number 3 with type Externaltypereference847megaco_per_bin_drv_media_gateway_control_prev3aNonStandardData
...
%% attribute number 2 with type Externaltypereference827megaco_per_bin_drv_media_gateway_control_prev3aValue
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3aEventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference756megaco_per_bin_drv_media_gateway_control_prev3aSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference747megaco_per_bin_drv_media_gateway_control_prev3aSecondRequestedActions
...
%% attribute number 2 with type Externaltypereference724megaco_per_bin_drv_media_gateway_control_prev3aEventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference725megaco_per_bin_drv_media_gateway_control_prev3aSecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference726megaco_per_bin_drv_media_gateway_control_prev3aSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference716megaco_per_bin_drv_media_gateway_control_prev3aRequestedActions
...
%% attribute number 3 with type Externaltypereference687megaco_per_bin_drv_media_gateway_control_prev3aNonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference569megaco_per_bin_drv_media_gateway_control_prev3aLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference570megaco_per_bin_drv_media_gateway_control_prev3aLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference571megaco_per_bin_drv_media_gateway_control_prev3aLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference573megaco_per_bin_drv_media_gateway_control_prev3aStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference564megaco_per_bin_drv_media_gateway_control_prev3aStreamParms
...
%% attribute number 1 with type Externaltypereference552megaco_per_bin_drv_media_gateway_control_prev3aTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference523megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference524megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference516megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference517megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeParm
...
%% attribute number 2 with type Externaltypereference502megaco_per_bin_drv_media_gateway_control_prev3aValue
'enc_Value'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval3 ->
...
%% attribute number 4 with type Externaltypereference493megaco_per_bin_drv_media_gateway_control_prev3aTimeNotation
...
%% attribute number 1 with type Externaltypereference477megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference478megaco_per_bin_drv_media_gateway_control_prev3aErrorDescriptor
...
%% attribute number 1 with type Externaltypereference469megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference470megaco_per_bin_drv_media_gateway_control_prev3aObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference471megaco_per_bin_drv_media_gateway_control_prev3aErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
%% attribute number 2 with type Externaltypereference440megaco_per_bin_drv_media_gateway_control_prev3aIndAudSignal
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3aIndAudPropertyGroup
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3aIndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3aIndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference378megaco_per_bin_drv_media_gateway_control_prev3aIndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3aIndAudStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference371megaco_per_bin_drv_media_gateway_control_prev3aIndAudStreamParms
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3aIndAudTerminationStateDescriptor
...
%% attribute number 1 with type Externaltypereference302megaco_per_bin_drv_media_gateway_control_prev3aTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference303megaco_per_bin_drv_media_gateway_control_prev3aTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference286megaco_per_bin_drv_media_gateway_control_prev3aTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference287megaco_per_bin_drv_media_gateway_control_prev3aAuditDescriptor
...
%% attribute number 1 with type Externaltypereference279megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference280megaco_per_bin_drv_media_gateway_control_prev3aAuditDescriptor
...
%% attribute number 1 with type Externaltypereference272megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference273megaco_per_bin_drv_media_gateway_control_prev3aTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference248megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
...
%% attribute number 1 with type Externaltypereference234megaco_per_bin_drv_media_gateway_control_prev3aTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference235megaco_per_bin_drv_media_gateway_control_prev3aTerminationID
...
%% attribute number 1 with type Externaltypereference198megaco_per_bin_drv_media_gateway_control_prev3aCommand
...
%% attribute number 2 with type Externaltypereference171megaco_per_bin_drv_media_gateway_control_prev3aErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference172megaco_per_bin_drv_media_gateway_control_prev3aContextRequest
...
%% attribute number 2 with type Externaltypereference163megaco_per_bin_drv_media_gateway_control_prev3aContextRequest
...
%% attribute number 3 with type Externaltypereference164megaco_per_bin_drv_media_gateway_control_prev3aContextAttrAuditRequest
...
%% attribute number 2 with type Externaltypereference31megaco_per_bin_drv_media_gateway_control_prev3aMId
...
%% attribute number 1 with type Externaltypereference10megaco_per_bin_drv_media_gateway_control_prev3aAuthenticationHeader
'enc_AuthenticationHeader'(Tmpval1)
end,

%% attribute number 2 with type Externaltypereference11megaco_per_bin_drv_media_gateway_control_prev3aMessage
