...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:NonStandardIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:Value OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:ServiceChangeAddress OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_prev3b:ServiceChangeProfile OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 5   External megaco_ber_media_gateway_control_prev3b:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 5   External megaco_ber_media_gateway_control_prev3b:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 7   External megaco_ber_media_gateway_control_prev3b:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 8   External megaco_ber_media_gateway_control_prev3b:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 9   External megaco_ber_media_gateway_control_prev3b:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 10   External megaco_ber_media_gateway_control_prev3b:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:DigitMapValue OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:EventDM OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:SecondRequestedActions OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_prev3b:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:RequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case ?RT_BER:cindex(4,Val,eventAction) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:LocalControlDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_prev3b:StatisticsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:StreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:TerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(?RT_BER:cindex(2,Val,terminationID), [{tag,128,0,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:ServiceChangeResult
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:ServiceChangeParm
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_prev3b:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:ObservedEventsDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_ObservedEventsDescriptor'(?RT_BER:cindex(3,Val,observedEventsDescriptor), [{tag,128,1,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:IndAudSignal OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:IndAudPropertyGroup
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:IndAudLocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case ?RT_BER:cindex(2,Val,localControlDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case ?RT_BER:cindex(3,Val,localDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case ?RT_BER:cindex(4,Val,remoteDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_prev3b:IndAudStatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case ?RT_BER:cindex(5,Val,statisticsDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:IndAudStreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:IndAudTerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case ?RT_BER:cindex(2,Val,termStateDescr) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:TerminationID
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationID'(?RT_BER:cindex(2,Val,terminationID), [{tag,128,0,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:TerminationAudit
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:AuditDescriptor
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:TerminationAudit OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:TerminationID
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:Command
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:ContextRequest OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:ContextRequest OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_prev3b:ContextAttrAuditRequest OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:MId
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_prev3b:AuthenticationHeader OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_prev3b:Message
%%-------------------------------------------------
