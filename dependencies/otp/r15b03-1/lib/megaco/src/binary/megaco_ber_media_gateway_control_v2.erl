...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:NonStandardIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:Value OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:ServiceChangeAddress OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_v2:ServiceChangeProfile OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 5   External megaco_ber_media_gateway_control_v2:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 5   External megaco_ber_media_gateway_control_v2:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 7   External megaco_ber_media_gateway_control_v2:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 8   External megaco_ber_media_gateway_control_v2:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 9   External megaco_ber_media_gateway_control_v2:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 10   External megaco_ber_media_gateway_control_v2:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
{ asn1_NOVALUE, Bytes11, 0 }
   ...
   {{'ServiceChangeParm', Term1, Term2, Term3, Term4, Term5, Term6, Term7, Term8, Term9, Term10}, Bytes13, Rb1+Rb2+Rb3+Rb4+Rb5+Rb6+Rb7+Rb8+Rb9+Rb10+Rb11+Rb12}.
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:DigitMapValue OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:EventDM OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:SecondRequestedActions OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_v2:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:RequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case ?RT_BER:cindex(4,Val,eventAction) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:LocalControlDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:StreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:TerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(?RT_BER:cindex(2,Val,terminationID), [{tag,128,0,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:ServiceChangeResult
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:ServiceChangeParm
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_v2:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:ObservedEventsDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_ObservedEventsDescriptor'(?RT_BER:cindex(3,Val,observedEventsDescriptor), [{tag,128,1,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:IndAudSignal OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:IndAudPropertyGroup
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:IndAudLocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case ?RT_BER:cindex(2,Val,localControlDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case ?RT_BER:cindex(3,Val,localDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case ?RT_BER:cindex(4,Val,remoteDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
{ asn1_NOVALUE, Bytes4, 0 }
   ...
   {Bytes6,Rb5} = ?RT_BER:restbytes2(RemBytes, Bytes5,ext),
   {{'IndAudStreamParms', Term1, Term2, Term3}, Bytes6, Rb1+Rb2+Rb3+Rb4+Rb5}.
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:IndAudStreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:IndAudTerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case ?RT_BER:cindex(2,Val,termStateDescr) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:TerminationID
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationID'(?RT_BER:cindex(2,Val,terminationID), [{tag,128,0,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:TerminationAudit
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:AuditDescriptor
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:TerminationAudit OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:TerminationID
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:Command
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:ContextRequest OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:ContextRequest OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v2:ContextAttrAuditRequest OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:MId
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v2:AuthenticationHeader OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v2:Message
%%-------------------------------------------------
