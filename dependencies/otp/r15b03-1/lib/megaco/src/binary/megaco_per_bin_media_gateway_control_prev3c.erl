%% Generated by the Erlang ASN.1 BER-compiler version, utilizing bit-syntax:1.8
%% Purpose: encoder and decoder to the types in mod megaco_per_bin_media_gateway_control_prev3c

-module('megaco_per_bin_media_gateway_control_prev3c').
-include("megaco_per_bin_media_gateway_control_prev3c.hrl").
-define('RT_PER',asn1rt_per_bin).
-asn1_info([{vsn,'1.8'},
            {module,'megaco_per_bin_media_gateway_control_prev3c'},
            {options,[warnings,per_bin,errors,{cwd,[47,110,101,116,47,105,115,105,108,100,117,114,47,108,100,105,115,107,47,100,97,105,108,121,95,98,117,105,108,100,47,114,49,53,98,48,51,95,112,114,101,98,117,105,108,100,95,111,112,117,95,111,46,50,48,49,50,45,49,50,45,48,54,95,49,56,47,111,116,112,95,115,114,99,95,82,49,53,66,48,51,47,108,105,98,47,109,101,103,97,99,111,47,115,114,99,47,98,105,110,97,114,121]},{outdir,[47,110,101,116,47,105,115,105,108,100,117,114,47,108,100,105,115,107,47,100,97,105,108,121,95,98,117,105,108,100,47,114,49,53,98,48,51,95,112,114,101,98,117,105,108,100,95,111,112,117,95,111,46,50,48,49,50,45,49,50,45,48,54,95,49,56,47,111,116,112,95,115,114,99,95,82,49,53,66,48,51,47,108,105,98,47,109,101,103,97,99,111,47,115,114,99,47,98,105,110,97,114,121]},noobj,{i,[46]},{i,[47,110,101,116,47,105,115,105,108,100,117,114,47,108,100,105,115,107,47,100,97,105,108,121,95,98,117,105,108,100,47,114,49,53,98,48,51,95,112,114,101,98,117,105,108,100,95,111,112,117,95,111,46,50,48,49,50,45,49,50,45,48,54,95,49,56,47,111,116,112,95,115,114,99,95,82,49,53,66,48,51,47,108,105,98,47,109,101,103,97,99,111,47,115,114,99,47,98,105,110,97,114,121]}]}]).
...
%% attribute number 1 with type Externaltypereference1043megaco_per_bin_media_gateway_control_prev3cNonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference1035megaco_per_bin_media_gateway_control_prev3cValue
'enc_Value'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cMId
'enc_MId'(Tmpval1)
end,
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference998megaco_per_bin_media_gateway_control_prev3cServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference999megaco_per_bin_media_gateway_control_prev3cTimeNotation
...
%% attribute number 2 with type Externaltypereference958megaco_per_bin_media_gateway_control_prev3cServiceChangeAddress
'enc_ServiceChangeAddress'(Tmpval2)
end,
case ?RT_PER:cindex(4,Val1,serviceChangeVersion) of
asn1_NOVALUE -> [];
...
%% attribute number 4 with type Externaltypereference960megaco_per_bin_media_gateway_control_prev3cServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval4)
end,

%% attribute number 5 with type Externaltypereference961megaco_per_bin_media_gateway_control_prev3cValue
...
%% attribute number 7 with type Externaltypereference974megaco_per_bin_media_gateway_control_prev3cMId
'enc_MId'(Tmpval6)
end,
...
%% attribute number 8 with type Externaltypereference975megaco_per_bin_media_gateway_control_prev3cTimeNotation
'enc_TimeNotation'(Tmpval7)
end,
case ?RT_PER:cindex(10,Val1,nonStandardData) of
asn1_NOVALUE -> [];
Tmpval8 ->

%% attribute number 9 with type Externaltypereference976megaco_per_bin_media_gateway_control_prev3cNonStandardData
'enc_NonStandardData'(Tmpval8)
end
,Extensions
,
...
%% attribute number 10 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cAuditDescriptor
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_AuditDescriptor'(Tmpval9)))
end,
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_null(Tmpval10)))
end].
...
%% attribute number 3 with type INTEGER
?RT_PER:encode_integer([{'ValueRange',{0,99}}],Tmpval4)
end,
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,99}}],Tmpval5)))
end].
...
%% attribute number 2 with type Externaltypereference935megaco_per_bin_media_gateway_control_prev3cDigitMapValue
...
%% attribute number 3 with type Externaltypereference915megaco_per_bin_media_gateway_control_prev3cNonStandardData
...
%% attribute number 2 with type Externaltypereference896megaco_per_bin_media_gateway_control_prev3cValue
...
'enc_NotifyCompletion'(Val) ->
?RT_PER:encode_bit_string([],Val,[{onTimeOut,0},{onInterruptByEvent,1},{onInterruptByNewSignalDescr,2},{otherReason,3},{onIteration,4}]).
...
'enc_SignalDirection'(Val) ->
case (case Val of {_,Enumval1}-> Enumval1;_->Val end) of
'internal' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 0)];
'external' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 1)];
'both' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 2)];
...
%% attribute number 4 with type INTEGER
?RT_PER:encode_integer([{'ValueRange',{0,65535}}],Tmpval4)
end,
...
?RT_PER:encode_bit_string([],Tmpval5,[{onTimeOut,0},{onInterruptByEvent,1},{onInterruptByNewSignalDescr,2},{otherReason,3},{onIteration,4}])
end,
...
,Extensions
,
case ?RT_PER:cindex(9,Val1,direction) of
asn1_NOVALUE -> [];
Tmpval7 ->

%% attribute number 8 with type ENUMERATED
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval7 of {_,Enumval8}-> Enumval8;_->Tmpval7 end) of
'internal' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 0)];
'external' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 1)];
'both' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 2)];
...
case ?RT_PER:cindex(10,Val1,requestID) of
asn1_NOVALUE -> [];
Tmpval8 ->

%% attribute number 9 with type INTEGER
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,4294967295}}],Tmpval8)))
end,
case ?RT_PER:cindex(11,Val1,intersigDelay) of
asn1_NOVALUE -> [];
Tmpval9 ->

%% attribute number 10 with type INTEGER
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,65535}}],Tmpval9)))
end].
...
{TmpValx9,_}=?RT_PER:decode_integer(TmpVal9,[{'ValueRange',{0,4294967295}}]), {TmpValx9,Trem9}
end;
_  ->
...
%% attribute number 10 with type INTEGER
{Term10,Bytes13} = case Extensions of
  _ when size(Extensions) >= 3,element(3,Extensions) == 1 ->
begin
{TmpVal10,Trem10}=?RT_PER:decode_open_type(Bytes12,[]),
{TmpValx10,_}=?RT_PER:decode_integer(TmpVal10,[{'ValueRange',{0,65535}}]), {TmpValx10,Trem10}
end;
_  ->
{asn1_NOVALUE,Bytes12}
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cEventDM
'enc_EventDM'(Tmpval3)
end,
...
%% attribute number 3 with type Externaltypereference822megaco_per_bin_media_gateway_control_prev3cSignalsDescriptor
'enc_SignalsDescriptor'(Tmpval4)
end
,Extensions
,
case ?RT_PER:cindex(5,Val1,notifyBehaviour) of
asn1_NOVALUE -> [];
Tmpval5 ->

%% attribute number 4 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cNotifyBehaviour
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_NotifyBehaviour'(Tmpval5)))
end,
case ?RT_PER:cindex(6,Val1,resetEventsDescriptor) of
asn1_NOVALUE -> [];
Tmpval6 ->
...
%% attribute number 3 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cSecondRequestedActions
...
%% attribute number 2 with type Externaltypereference788megaco_per_bin_media_gateway_control_prev3cEventDM
'enc_EventDM'(Tmpval3)
end,
...
%% attribute number 3 with type Externaltypereference789megaco_per_bin_media_gateway_control_prev3cSecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference790megaco_per_bin_media_gateway_control_prev3cSignalsDescriptor
'enc_SignalsDescriptor'(Tmpval5)
end
,Extensions
,
case ?RT_PER:cindex(6,Val1,notifyBehaviour) of
asn1_NOVALUE -> [];
Tmpval6 ->

%% attribute number 5 with type Externaltypereference792megaco_per_bin_media_gateway_control_prev3cNotifyBehaviour
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_NotifyBehaviour'(Tmpval6)))
end,
case ?RT_PER:cindex(7,Val1,resetEventsDescriptor) of
asn1_NOVALUE -> [];
Tmpval7 ->
...
[
?RT_PER:setext(false), Opt,
case ?RT_PER:cindex(2,Val1,secondEvent) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cSecondEventsDescriptor
'enc_SecondEventsDescriptor'(Tmpval1)
end,
case ?RT_PER:cindex(3,Val1,signalsDescriptor) of
asn1_NOVALUE -> [];
Tmpval2 ->

%% attribute number 2 with type Externaltypereference773megaco_per_bin_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference765megaco_per_bin_media_gateway_control_prev3cRequestedActions
...
%% attribute number 3 with type Externaltypereference736megaco_per_bin_media_gateway_control_prev3cNonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference618megaco_per_bin_media_gateway_control_prev3cLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference619megaco_per_bin_media_gateway_control_prev3cLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference620megaco_per_bin_media_gateway_control_prev3cLocalRemoteDescriptor
'enc_LocalRemoteDescriptor'(Tmpval4)
end
,Extensions
,
case ?RT_PER:cindex(5,Val1,statisticsDescriptor) of
asn1_NOVALUE -> [];
Tmpval5 ->

%% attribute number 4 with type Externaltypereference622megaco_per_bin_media_gateway_control_prev3cStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference613megaco_per_bin_media_gateway_control_prev3cStreamParms
...
%% attribute number 1 with type Externaltypereference601megaco_per_bin_media_gateway_control_prev3cTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference573megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference574megaco_per_bin_media_gateway_control_prev3cServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference566megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference567megaco_per_bin_media_gateway_control_prev3cServiceChangeParm
...
%% attribute number 2 with type Externaltypereference552megaco_per_bin_media_gateway_control_prev3cValue
'enc_Value'(?RT_PER:cindex(3,Val1,value)),
case ?RT_PER:cindex(4,Val1,extraInfo) of
asn1_NOVALUE -> [];
Tmpval1 ->
...
%% attribute number 4 with type Externaltypereference543megaco_per_bin_media_gateway_control_prev3cTimeNotation
...
%% attribute number 1 with type Externaltypereference527megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference528megaco_per_bin_media_gateway_control_prev3cErrorDescriptor
...
%% attribute number 1 with type Externaltypereference519megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference520megaco_per_bin_media_gateway_control_prev3cObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(?RT_PER:cindex(3,Val1,observedEventsDescriptor)),
case ?RT_PER:cindex(4,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference521megaco_per_bin_media_gateway_control_prev3cErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
,Extensions
,
case ?RT_PER:cindex(4,Val1,signalRequestID) of
asn1_NOVALUE -> [];
Tmpval3 ->

%% attribute number 3 with type INTEGER
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,4294967295}}],Tmpval3)))
end].
...
{TmpValx3,_}=?RT_PER:decode_integer(TmpVal3,[{'ValueRange',{0,4294967295}}]), {TmpValx3,Trem3}
end;
_  ->
{asn1_NOVALUE,Bytes5}
...
%% attribute number 2 with type Externaltypereference489megaco_per_bin_media_gateway_control_prev3cIndAudSignal
...
%% attribute number 3 with type INTEGER
{Term3,Bytes5} = case Opt band (1 bsl 0) of
  _Opt3 when _Opt3 > 0 ->?RT_PER:decode_integer(Bytes4,[{'ValueRange',{0,65535}}]);
0 ->{asn1_NOVALUE,Bytes4}
...
,Extensions
,
case ?RT_PER:cindex(5,Val1,serviceStateSel) of
asn1_NOVALUE -> [];
Tmpval4 ->

%% attribute number 4 with type ENUMERATED
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval4 of {_,Enumval3}-> Enumval3;_->Tmpval4 end) of
'test' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 0)];
'outOfSvc' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 1)];
'inSvc' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 2)];
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cIndAudPropertyGroup
...
?RT_PER:encode_octet_string([{'SizeConstraint',4}],?RT_PER:cindex(2,Val1,name))
,Extensions
, case ?RT_PER:cindex(3,Val1,propertyParms) of
asn1_NOVALUE -> [];
Tmpval2 ->

%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cPropertyParm
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_PropertyParm'(Tmpval2)))
end].
...
,Extensions
,
case ?RT_PER:cindex(6,Val1,streamModeSel) of
asn1_NOVALUE -> [];
Tmpval6 ->

%% attribute number 5 with type ENUMERATED
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval6 of {_,Enumval4}-> Enumval4;_->Tmpval6 end) of
'sendOnly' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,4}}], 0)];
'recvOnly' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,4}}], 1)];
'sendRecv' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,4}}], 2)];
'inactive' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,4}}], 3)];
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cIndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cIndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference418megaco_per_bin_media_gateway_control_prev3cIndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cIndAudStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference411megaco_per_bin_media_gateway_control_prev3cIndAudStreamParms
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_prev3cIndAudTerminationStateDescriptor
...
?RT_PER:encode_bit_string([],Tmpval2,[{muxToken,0},{modemToken,1},{mediaToken,2},{eventsToken,3},{signalsToken,4},{digitMapToken,5},{statsToken,6},{observedEventsToken,7},{packagesToken,8},{eventBufferToken,9}])
end
,Extensions
,
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference343megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationIDList)),

%% attribute number 2 with type Externaltypereference344megaco_per_bin_media_gateway_control_prev3cTerminationAudit
...
%% attribute number 1 with type Externaltypereference337megaco_per_bin_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference338megaco_per_bin_media_gateway_control_prev3cTerminationAudit
'enc_TerminationAudit'(?RT_PER:cindex(3,Val1,terminationAuditResult))].
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference317megaco_per_bin_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference318megaco_per_bin_media_gateway_control_prev3cAuditDescriptor
'enc_AuditDescriptor'(?RT_PER:cindex(3,Val1,auditDescriptor))
,Extensions
, case ?RT_PER:cindex(4,Val1,terminationIDList) of
asn1_NOVALUE -> [];
Tmpval2 ->

%% attribute number 3 with type Externaltypereference320megaco_per_bin_media_gateway_control_prev3cTerminationIDList
...
%% attribute number 1 with type Externaltypereference310megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,auditDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference311megaco_per_bin_media_gateway_control_prev3cAuditDescriptor
...
%% attribute number 1 with type Externaltypereference303megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,terminationAudit) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference304megaco_per_bin_media_gateway_control_prev3cTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference279megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference256megaco_per_bin_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationFrom)),

%% attribute number 2 with type Externaltypereference257megaco_per_bin_media_gateway_control_prev3cTerminationID
...
%% attribute number 4 with type INTEGER
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,65535}}],Tmpval2)))
end,
case ?RT_PER:cindex(6,Val1,topologyDirectionExtension) of
asn1_NOVALUE -> [];
Tmpval3 ->

%% attribute number 5 with type ENUMERATED
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval3 of {_,Enumval3}-> Enumval3;_->Tmpval3 end) of
'onewayexternal' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,1}}], 0)];
'onewayboth' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,1}}], 1)];
...
%% attribute number 1 with type Externaltypereference220megaco_per_bin_media_gateway_control_prev3cCommand
...
,Extensions
,
case ?RT_PER:cindex(5,Val1,iepscallind) of
asn1_NOVALUE -> [];
Tmpval5 ->
...
case ?RT_PER:cindex(6,Val1,contextPropAud) of
asn1_NOVALUE -> [];
Tmpval6 ->
...
case ?RT_PER:cindex(7,Val1,selectpriority) of
asn1_NOVALUE -> [];
Tmpval7 ->

%% attribute number 6 with type INTEGER
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,15}}],Tmpval7)))
end,
case ?RT_PER:cindex(8,Val1,selectemergency) of
asn1_NOVALUE -> [];
Tmpval8 ->

%% attribute number 7 with type BOOLEAN
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_boolean(Tmpval8)))
end,
case ?RT_PER:cindex(9,Val1,selectiepscallind) of
asn1_NOVALUE -> [];
Tmpval9 ->

%% attribute number 8 with type BOOLEAN
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_boolean(Tmpval9)))
end,
case ?RT_PER:cindex(10,Val1,selectLogic) of
asn1_NOVALUE -> [];
Tmpval10 ->

%% attribute number 9 with type Externaltypereference207megaco_per_bin_media_gateway_control_prev3cSelectLogic
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_SelectLogic'(Tmpval10)))
end].
...
begin
{TmpVal6,Trem6}=?RT_PER:decode_open_type(Bytes8,[]),
{TmpValx6,_}=?RT_PER:decode_integer(TmpVal6,[{'ValueRange',{0,15}}]), {TmpValx6,Trem6}
end;
_  ->
{asn1_NOVALUE,Bytes8}
...
{Term7,Bytes10} = case Extensions of
  _ when size(Extensions) >= 4,element(4,Extensions) == 1 ->
begin
...
%% attribute number 8 with type BOOLEAN
{Term8,Bytes11} = case Extensions of
  _ when size(Extensions) >= 5,element(5,Extensions) == 1 ->
begin
{TmpVal8,Trem8}=?RT_PER:decode_open_type(Bytes10,[]),
...
{Term9,Bytes12} = case Extensions of
  _ when size(Extensions) >= 6,element(6,Extensions) == 1 ->
begin
{TmpVal9,Trem9}=?RT_PER:decode_open_type(Bytes11,[]),
...
%% attribute number 1 with type INTEGER
?RT_PER:encode_integer([{'ValueRange',{0,15}}],Tmpval2)
end,
case ?RT_PER:cindex(3,Val1,emergency) of
asn1_NOVALUE -> [];
Tmpval3 ->
...
%% attribute number 3 with type SEQUENCE OF
'enc_ContextRequest_topologyReq'(Tmpval4)
end
,Extensions
,
case ?RT_PER:cindex(5,Val1,iepscallind) of
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_boolean(Tmpval5)))
end,
case ?RT_PER:cindex(6,Val1,contextProp) of
asn1_NOVALUE -> [];
Tmpval6 ->

%% attribute number 5 with type SEQUENCE OF
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_ContextRequest_contextProp'(Tmpval6)))
end,
case ?RT_PER:cindex(7,Val1,contextList) of
asn1_NOVALUE -> [];
Tmpval7 ->

%% attribute number 6 with type SEQUENCE OF
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_ContextRequest_contextList'(Tmpval7)))
end].
...
'enc_ContextRequest_contextList_components'(T, [?RT_PER:encode_integer([{'ValueRange',{0,4294967295}}],H) | Acc]).
...
'dec_ContextRequest_contextList_components'(Num, Bytes, _, Acc) ->
   {Term,Remain} = ?RT_PER:decode_integer(Bytes,[{'ValueRange',{0,4294967295}}]),
...
%% attribute number 2 with type Externaltypereference171megaco_per_bin_media_gateway_control_prev3cErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
...
%% attribute number 3 with type Externaltypereference172megaco_per_bin_media_gateway_control_prev3cContextRequest
...
%% attribute number 2 with type Externaltypereference163megaco_per_bin_media_gateway_control_prev3cContextRequest
...
%% attribute number 3 with type Externaltypereference164megaco_per_bin_media_gateway_control_prev3cContextAttrAuditRequest
...
,Extensions
,
case ?RT_PER:cindex(5,Val1,segmentNumber) of
asn1_NOVALUE -> [];
Tmpval3 ->

%% attribute number 4 with type INTEGER
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,65535}}],Tmpval3)))
end,
case ?RT_PER:cindex(6,Val1,segmentationComplete) of
asn1_NOVALUE -> [];
Tmpval4 ->

%% attribute number 5 with type NULL
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_null(Tmpval4)))
end].
...
%% attribute number 2 with type Externaltypereference31megaco_per_bin_media_gateway_control_prev3cMId
...
%% attribute number 1 with type Externaltypereference10megaco_per_bin_media_gateway_control_prev3cAuthenticationHeader
'enc_AuthenticationHeader'(Tmpval1)
end,

%% attribute number 2 with type Externaltypereference11megaco_per_bin_media_gateway_control_prev3cMessage
