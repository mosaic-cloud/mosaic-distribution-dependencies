...
-export(['ansi-X9-62'/0, anyExtendedKeyUsage/0,
	 ...
	 'characteristic-two-field'/0, 'common-name'/0, data/0,
	 ...
	 dec_CRLReason/2, dec_CRLSequence/2, dec_CertPolicyId/2,
	 dec_Certificate/2, dec_CertificateIssuer/2,
	 dec_CertificateList/2, dec_CertificatePolicies/2,
	 dec_CertificateRevocationLists/2,
	 dec_CertificateSerialNumber/2, dec_Certificates/2,
	 dec_CertificationRequest/2,
	 dec_CertificationRequestInfo/2,
	 'dec_Characteristic-two'/2, dec_ClassList/2,
	 dec_Clearance/2, dec_CommonName/2,
	 dec_ContentEncryptionAlgorithmIdentifier/2,
	 dec_ContentInfo/2, dec_ContentType/2, dec_CountryName/2,
	 dec_Curve/2, dec_DHParameter/2, dec_DHPublicKey/2,
	 dec_DSAParams/2, dec_DSAPrivateKey/2,
	 dec_DSAPublicKey/2, dec_Data/2, dec_Digest/2,
	 dec_DigestAlgorithmIdentifier/2,
	 dec_DigestAlgorithmIdentifiers/2,
	 dec_DigestEncryptionAlgorithmIdentifier/2,
	 dec_DigestInfoNull/2, 'dec_DigestInfoPKCS-1'/2,
	 'dec_DigestInfoPKCS-7'/2, dec_DigestedData/2,
	 ...
	 dec_EmailAddress/2, dec_EncryptedContent/2,
	 dec_EncryptedContentInfo/2, dec_EncryptedData/2,
	 dec_EncryptedDigest/2, dec_EncryptedKey/2,
	 dec_EnvelopedData/2, dec_ExtKeyUsageSyntax/2,
	 ...
	 dec_IssuerAltName/2, dec_IssuerAndSerialNumber/2,
	 dec_IssuerSerial/2, dec_IssuingDistributionPoint/2,
	 'dec_KEA-Parms-Id'/2, 'dec_KEA-PublicKey'/2,
	 dec_KeyEncryptionAlgorithmIdentifier/2,
	 dec_KeyIdentifier/2, dec_KeyPurposeId/2, dec_KeyUsage/2,
	 dec_LocalPostalAttributes/2, dec_MessageDigest/2,
	 dec_Name/2, dec_NameConstraints/2, dec_NetworkAddress/2,
	 dec_NoticeReference/2, dec_NumericUserIdentifier/2,
	 dec_ORAddress/2, 'dec_OTP-X520countryname'/2,
	 dec_OTPAttributeTypeAndValue/2, dec_OTPCertificate/2,
	 'dec_OTPCharacteristic-two'/2, dec_OTPExtension/2,
	 ...
	 dec_ReasonFlags/2, dec_RecipientInfo/2,
	 dec_RecipientInfos/2, dec_RelativeDistinguishedName/2,
	 dec_RoleSyntax/2, dec_SecurityCategory/2,
	 dec_SignatureAlgorithm/2,
	 'dec_SignatureAlgorithm-Any'/2,
	 dec_SignedAndEnvelopedData/2, dec_SignedData/2,
	 dec_SignerInfo/2, dec_SignerInfos/2, dec_SigningTime/2,
	 dec_SkipCerts/2, dec_StreetAddress/2,
	 dec_SubjectAltName/2, dec_SubjectDirectoryAttributes/2,
	 ...
	 dec_commonName/3, dec_contentType/3,
	 dec_counterSignature/3, dec_countryName/3,
	 ...
	 'dec_md5-with-rsa-encryption'/3, dec_messageDigest/3,
	 dec_name/3, dec_nameConstraints/3,
	 dec_organizationName/3, dec_organizationalUnitName/3,
	 dec_policyConstraints/3, dec_policyMappings/3,
	 'dec_pp-basis'/3, dec_privateKeyUsagePeriod/3,
	 dec_pseudonym/3, 'dec_rsa-encryption'/3,
	 dec_serialNumber/3, 'dec_sha1-with-rsa-encryption'/3,
	 'dec_sha256-with-rsa-encryption'/3,
	 'dec_sha384-with-rsa-encryption'/3,
	 'dec_sha512-with-rsa-encryption'/3, dec_signingTime/3,
	 ...
	 digestedData/0, 'ecdsa-with-SHA1'/0, ellipticCurve/0,
	 enc_AAControls/2, enc_ACClearAttrs/2,
	 enc_AccessDescription/2, enc_AdministrationDomainName/2,
	 enc_Algorithm/2, enc_AlgorithmIdentifier/2,
	 enc_AlgorithmNull/2, enc_AnotherName/2, enc_Any/2,
	 ...
	 enc_CRLReason/2, enc_CRLSequence/2, enc_CertPolicyId/2,
	 enc_Certificate/2, enc_CertificateIssuer/2,
	 enc_CertificateList/2, enc_CertificatePolicies/2,
	 enc_CertificateRevocationLists/2,
	 enc_CertificateSerialNumber/2, enc_Certificates/2,
	 enc_CertificationRequest/2,
	 enc_CertificationRequestInfo/2,
	 'enc_Characteristic-two'/2, enc_ClassList/2,
	 enc_Clearance/2, enc_CommonName/2,
	 enc_ContentEncryptionAlgorithmIdentifier/2,
	 enc_ContentInfo/2, enc_ContentType/2, enc_CountryName/2,
	 enc_Curve/2, enc_DHParameter/2, enc_DHPublicKey/2,
	 enc_DSAParams/2, enc_DSAPrivateKey/2,
	 enc_DSAPublicKey/2, enc_Data/2, enc_Digest/2,
	 enc_DigestAlgorithmIdentifier/2,
	 enc_DigestAlgorithmIdentifiers/2,
	 enc_DigestEncryptionAlgorithmIdentifier/2,
	 enc_DigestInfoNull/2, 'enc_DigestInfoPKCS-1'/2,
	 'enc_DigestInfoPKCS-7'/2, enc_DigestedData/2,
	 ...
	 enc_EmailAddress/2, enc_EncryptedContent/2,
	 enc_EncryptedContentInfo/2, enc_EncryptedData/2,
	 enc_EncryptedDigest/2, enc_EncryptedKey/2,
	 enc_EnvelopedData/2, enc_ExtKeyUsageSyntax/2,
	 ...
	 enc_IssuerAltName/2, enc_IssuerAndSerialNumber/2,
	 enc_IssuerSerial/2, enc_IssuingDistributionPoint/2,
	 'enc_KEA-Parms-Id'/2, 'enc_KEA-PublicKey'/2,
	 enc_KeyEncryptionAlgorithmIdentifier/2,
	 enc_KeyIdentifier/2, enc_KeyPurposeId/2, enc_KeyUsage/2,
	 enc_LocalPostalAttributes/2, enc_MessageDigest/2,
	 enc_Name/2, enc_NameConstraints/2, enc_NetworkAddress/2,
	 enc_NoticeReference/2, enc_NumericUserIdentifier/2,
	 enc_ORAddress/2, 'enc_OTP-X520countryname'/2,
	 enc_OTPAttributeTypeAndValue/2, enc_OTPCertificate/2,
	 'enc_OTPCharacteristic-two'/2, enc_OTPExtension/2,
	 ...
	 enc_ReasonFlags/2, enc_RecipientInfo/2,
	 enc_RecipientInfos/2, enc_RelativeDistinguishedName/2,
	 enc_RoleSyntax/2, enc_SecurityCategory/2,
	 enc_SignatureAlgorithm/2,
	 'enc_SignatureAlgorithm-Any'/2,
	 enc_SignedAndEnvelopedData/2, enc_SignedData/2,
	 enc_SignerInfo/2, enc_SignerInfos/2, enc_SigningTime/2,
	 enc_SkipCerts/2, enc_StreetAddress/2,
	 enc_SubjectAltName/2, enc_SubjectDirectoryAttributes/2,
	 ...
	 enc_commonName/3, enc_contentType/3,
	 enc_counterSignature/3, enc_countryName/3,
	 ...
	 'enc_md5-with-rsa-encryption'/3, enc_messageDigest/3,
	 enc_name/3, enc_nameConstraints/3,
	 enc_organizationName/3, enc_organizationalUnitName/3,
	 enc_policyConstraints/3, enc_policyMappings/3,
	 'enc_pp-basis'/3, enc_privateKeyUsagePeriod/3,
	 enc_pseudonym/3, 'enc_rsa-encryption'/3,
	 enc_serialNumber/3, 'enc_sha1-with-rsa-encryption'/3,
	 'enc_sha256-with-rsa-encryption'/3,
	 'enc_sha384-with-rsa-encryption'/3,
	 'enc_sha512-with-rsa-encryption'/3, enc_signingTime/3,
	 ...
	 encode_disp/2, encoding_rule/0, encryptedData/0,
	 envelopedData/0, 'extended-network-address'/0,
	 'extension-OR-address-components'/0,
	 'extension-physical-delivery-address-components'/0,
	 getdec_Authenticated/2, getdec_CRIAttributes/2,
	 getdec_ContentEncryptionAlgorithms/2, getdec_Contents/2,
	 getdec_DigestAlgorithms/2,
	 getdec_DigestEncryptionAlgorithms/2,
	 getdec_KeyEncryptionAlgorithms/2,
	 getdec_PKInfoAlgorithms/2, getdec_SignatureAlgorithms/2,
	 ...
	 getenc_Authenticated/2, getenc_CRIAttributes/2,
	 getenc_ContentEncryptionAlgorithms/2, getenc_Contents/2,
	 getenc_DigestAlgorithms/2,
	 getenc_DigestEncryptionAlgorithms/2,
	 getenc_KeyEncryptionAlgorithms/2,
	 getenc_PKInfoAlgorithms/2, getenc_SignatureAlgorithms/2,
	 ...
	 getenc_internal_object_set_argument_9/2, gnBasis/0,
	 ...
	 'pkcs-3'/0, 'pkcs-7'/0, 'pkcs-9'/0,
	 'pkcs-9-at-contentType'/0,
	 'pkcs-9-at-counterSignature'/0,
	 'pkcs-9-at-messageDigest'/0, 'pkcs-9-at-signingTime'/0,
	 'post-office-box-address'/0, 'postal-code'/0,
	 'poste-restante-address'/0, ppBasis/0, 'prime-field'/0,
	 prime192v1/0, prime192v2/0, prime192v3/0, prime239v1/0,
	 prime239v2/0, prime239v3/0, prime256v1/0, primeCurve/0,
	 rsaEncryption/0, sha1WithRSAEncryption/0,
	 sha224WithRSAEncryption/0, sha256WithRSAEncryption/0,
	 sha384WithRSAEncryption/0, sha512WithRSAEncryption/0,
	 signedAndEnvelopedData/0, signedData/0,
...
-asn1_info([{vsn, '1.8'}, {module, 'OTP-PUB-KEY'},
	    {options,
	     [ber_bin_v2, warnings, errors,
	      {cwd,
	       "/net/isildur/ldisk/daily_build/r15b03_prebuil"
	       "d_opu_o.2012-12-06_18/otp_src_R15B03/lib/publ"
	       "ic_key/asn1"},
	      {outdir,
	       "/net/isildur/ldisk/daily_build/r15b03_prebuil"
	       "d_opu_o.2012-12-06_18/otp_src_R15B03/lib/publ"
...
encode_disp('DigestInfoPKCS-1', Data) ->
    'enc_DigestInfoPKCS-1'(Data);
...
encode_disp('DigestedData', Data) ->
    enc_DigestedData(Data);
encode_disp('SignedAndEnvelopedData', Data) ->
    enc_SignedAndEnvelopedData(Data);
encode_disp('EncryptedKey', Data) ->
    enc_EncryptedKey(Data);
encode_disp('RecipientInfo', Data) ->
    enc_RecipientInfo(Data);
encode_disp('EncryptedContent', Data) ->
    enc_EncryptedContent(Data);
encode_disp('EncryptedContentInfo', Data) ->
    enc_EncryptedContentInfo(Data);
encode_disp('RecipientInfos', Data) ->
    enc_RecipientInfos(Data);
encode_disp('EnvelopedData', Data) ->
    enc_EnvelopedData(Data);
encode_disp('Digest', Data) -> enc_Digest(Data);
encode_disp('DigestInfoPKCS-7', Data) ->
    'enc_DigestInfoPKCS-7'(Data);
encode_disp('EncryptedDigest', Data) ->
    enc_EncryptedDigest(Data);
encode_disp('SignerInfo', Data) -> enc_SignerInfo(Data);
encode_disp('DigestAlgorithmIdentifiers', Data) ->
    enc_DigestAlgorithmIdentifiers(Data);
encode_disp('SignerInfos', Data) ->
    enc_SignerInfos(Data);
encode_disp('SignedData', Data) -> enc_SignedData(Data);
encode_disp('Data', Data) -> enc_Data(Data);
encode_disp('ContentType', Data) ->
    enc_ContentType(Data);
encode_disp('ContentInfo', Data) ->
    enc_ContentInfo(Data);
encode_disp('KeyEncryptionAlgorithmIdentifier', Data) ->
    enc_KeyEncryptionAlgorithmIdentifier(Data);
encode_disp('IssuerAndSerialNumber', Data) ->
    enc_IssuerAndSerialNumber(Data);
encode_disp('ExtendedCertificatesAndCertificates',
	    Data) ->
    enc_ExtendedCertificatesAndCertificates(Data);
encode_disp('ExtendedCertificate', Data) ->
    enc_ExtendedCertificate(Data);
encode_disp('ExtendedCertificateOrCertificate', Data) ->
    enc_ExtendedCertificateOrCertificate(Data);
encode_disp('DigestEncryptionAlgorithmIdentifier',
	    Data) ->
    enc_DigestEncryptionAlgorithmIdentifier(Data);
encode_disp('DigestAlgorithmIdentifier', Data) ->
    enc_DigestAlgorithmIdentifier(Data);
encode_disp('ContentEncryptionAlgorithmIdentifier',
	    Data) ->
    enc_ContentEncryptionAlgorithmIdentifier(Data);
encode_disp('CRLSequence', Data) ->
    enc_CRLSequence(Data);
encode_disp('Certificates', Data) ->
    enc_Certificates(Data);
encode_disp('CertificateRevocationLists', Data) ->
    enc_CertificateRevocationLists(Data);
encode_disp('SigningTime', Data) ->
    enc_SigningTime(Data);
encode_disp('MessageDigest', Data) ->
    enc_MessageDigest(Data);
encode_disp('CertificationRequest', Data) ->
    enc_CertificationRequest(Data);
encode_disp('CertificationRequestInfo', Data) ->
...
encode_disp('OTP-X520countryname', Data) ->
    'enc_OTP-X520countryname'(Data);
...
decode_disp('DigestInfoPKCS-1', Data) ->
    'dec_DigestInfoPKCS-1'(Data);
...
decode_disp('DigestedData', Data) ->
    dec_DigestedData(Data);
decode_disp('SignedAndEnvelopedData', Data) ->
    dec_SignedAndEnvelopedData(Data);
decode_disp('EncryptedKey', Data) ->
    dec_EncryptedKey(Data);
decode_disp('RecipientInfo', Data) ->
    dec_RecipientInfo(Data);
decode_disp('EncryptedContent', Data) ->
    dec_EncryptedContent(Data);
decode_disp('EncryptedContentInfo', Data) ->
    dec_EncryptedContentInfo(Data);
decode_disp('RecipientInfos', Data) ->
    dec_RecipientInfos(Data);
decode_disp('EnvelopedData', Data) ->
    dec_EnvelopedData(Data);
decode_disp('Digest', Data) -> dec_Digest(Data);
decode_disp('DigestInfoPKCS-7', Data) ->
    'dec_DigestInfoPKCS-7'(Data);
decode_disp('EncryptedDigest', Data) ->
    dec_EncryptedDigest(Data);
decode_disp('SignerInfo', Data) -> dec_SignerInfo(Data);
decode_disp('DigestAlgorithmIdentifiers', Data) ->
    dec_DigestAlgorithmIdentifiers(Data);
decode_disp('SignerInfos', Data) ->
    dec_SignerInfos(Data);
decode_disp('SignedData', Data) -> dec_SignedData(Data);
decode_disp('Data', Data) -> dec_Data(Data);
decode_disp('ContentType', Data) ->
    dec_ContentType(Data);
decode_disp('ContentInfo', Data) ->
    dec_ContentInfo(Data);
decode_disp('KeyEncryptionAlgorithmIdentifier', Data) ->
    dec_KeyEncryptionAlgorithmIdentifier(Data);
decode_disp('IssuerAndSerialNumber', Data) ->
    dec_IssuerAndSerialNumber(Data);
decode_disp('ExtendedCertificatesAndCertificates',
	    Data) ->
    dec_ExtendedCertificatesAndCertificates(Data);
decode_disp('ExtendedCertificate', Data) ->
    dec_ExtendedCertificate(Data);
decode_disp('ExtendedCertificateOrCertificate', Data) ->
    dec_ExtendedCertificateOrCertificate(Data);
decode_disp('DigestEncryptionAlgorithmIdentifier',
	    Data) ->
    dec_DigestEncryptionAlgorithmIdentifier(Data);
decode_disp('DigestAlgorithmIdentifier', Data) ->
    dec_DigestAlgorithmIdentifier(Data);
decode_disp('ContentEncryptionAlgorithmIdentifier',
	    Data) ->
    dec_ContentEncryptionAlgorithmIdentifier(Data);
decode_disp('CRLSequence', Data) ->
    dec_CRLSequence(Data);
decode_disp('Certificates', Data) ->
    dec_Certificates(Data);
decode_disp('CertificateRevocationLists', Data) ->
    dec_CertificateRevocationLists(Data);
decode_disp('SigningTime', Data) ->
    dec_SigningTime(Data);
decode_disp('MessageDigest', Data) ->
    dec_MessageDigest(Data);
decode_disp('CertificationRequest', Data) ->
    dec_CertificationRequest(Data);
decode_disp('CertificationRequestInfo', Data) ->
...
decode_disp('OTP-X520countryname', Data) ->
    'dec_OTP-X520countryname'(Data);
...
enc_EncryptedData(Val, TagIn) ->
    ...
    %%-------------------------------------------------
    {EncBytes2, EncLen2} = enc_EncryptedContentInfo(Cindex2,
						    [<<48>>]),
    BytesSoFar = [EncBytes1, EncBytes2],
    LenSoFar = EncLen1 + EncLen2,
    encode_tags(TagIn, BytesSoFar, LenSoFar).

dec_EncryptedData(Tlv) -> dec_EncryptedData(Tlv, [16]).
...
dec_EncryptedData(Tlv, TagIn) ->
    ...
    %%-------------------------------------------------
    [V1 | Tlv2] = Tlv1,
    Term1 = decode_integer(V1, [], [{edVer0, 0}], [2]),
    %%-------------------------------------------------
    %% attribute encryptedContentInfo(2)   External OTP-PUB-KEY:EncryptedContentInfo
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
...
enc_DigestedData(Val, TagIn) ->
    ...
    %%-------------------------------------------------
    {EncBytes2, EncLen2} =
	enc_DigestAlgorithmIdentifier(Cindex2, [<<48>>]),
    %%-------------------------------------------------
    %% attribute contentInfo(3)   External OTP-PUB-KEY:ContentInfo
    %%-------------------------------------------------
    {EncBytes3, EncLen3} = enc_ContentInfo(Cindex3,
					   [<<48>>]),
    %%-------------------------------------------------
...
dec_DigestedData(Tlv) -> dec_DigestedData(Tlv, [16]).
...
dec_DigestedData(Tlv, TagIn) ->
    ...
    %%-------------------------------------------------
    [V1 | Tlv2] = Tlv1,
    Term1 = decode_integer(V1, [], [{ddVer0, 0}], [2]),
    %%-------------------------------------------------
    %% attribute digestAlgorithm(2)   External OTP-PUB-KEY:DigestAlgorithmIdentifier
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
...
enc_SignedAndEnvelopedData(Val, TagIn) ->
    ...
    %%-------------------------------------------------
    {EncBytes3, EncLen3} =
	enc_DigestAlgorithmIdentifiers(Cindex3, []),
    %%-------------------------------------------------
    %% attribute encryptedContentInfo(4)   External OTP-PUB-KEY:EncryptedContentInfo
    %%-------------------------------------------------
    {EncBytes4, EncLen4} = enc_EncryptedContentInfo(Cindex4,
						    [<<48>>]),
    %%-------------------------------------------------
    ...
    {EncBytes6, EncLen6} = case Cindex6 of
			     asn1_NOVALUE -> {<<>>, 0};
			     _ -> enc_SignedAndEnvelopedData_crls(Cindex6, [])
			   end,
    %%-------------------------------------------------
...
enc_SignedAndEnvelopedData_certificates({'SignedAndEnvelopedData_certificates',
					 Val},
					TagIn) ->
...
enc_SignedAndEnvelopedData_certificates(Val, TagIn) ->
    {EncBytes, EncLen} = case element(1, Val) of
			   certSet ->
			       enc_ExtendedCertificatesAndCertificates(element(2,
									       Val),
								       [<<160>>]);
			   certSequence ->
...
dec_SignedAndEnvelopedData_certificates(Tlv, TagIn) ->
	...
	of
      ...
      {131072, V1} ->
	  {certSet,
	   dec_ExtendedCertificatesAndCertificates(V1, [])};
      %% 'certSequence'
      {131074, V1} ->
...
enc_SignedAndEnvelopedData_crls({'SignedAndEnvelopedData_crls',
				 Val},
				TagIn) ->
...
enc_SignedAndEnvelopedData_crls(Val, TagIn) ->
    {EncBytes, EncLen} = case element(1, Val) of
			   crlSet ->
			       enc_CertificateRevocationLists(element(2, Val),
							      [<<161>>]);
			   crlSequence ->
...
dec_SignedAndEnvelopedData_crls(Tlv, TagIn) ->
	...
	of
      ...
      %% 'crlSequence'
      {131075, V1} -> {crlSequence, dec_CRLSequence(V1, [])};
      Else ->
	  exit({error, {asn1, {invalid_choice_tag, Else}}})
    end.
...
dec_SignedAndEnvelopedData(Tlv, TagIn) ->
    ...
    {Term5, Tlv6} = case Tlv5 of
			  ...
			  {dec_SignedAndEnvelopedData_certificates(V5, []),
			   TempTlv6};
    ...
    {'SignedAndEnvelopedData', Term1, Term2, Term3, Term4,
     Term5, Term6, Term7}.

%%================================
%%  EncryptedKey
%%================================
enc_EncryptedKey(Val) -> enc_EncryptedKey(Val, [<<4>>]).

enc_EncryptedKey({'EncryptedKey', Val}, TagIn) ->
    enc_EncryptedKey(Val, TagIn);
enc_EncryptedKey(Val, TagIn) ->
    encode_octet_string([], Val, TagIn).

dec_EncryptedKey(Tlv) -> dec_EncryptedKey(Tlv, [4]).
...
dec_RecipientInfo(Tlv) -> dec_RecipientInfo(Tlv, [16]).
...
dec_RecipientInfo(Tlv, TagIn) ->
    ...
    %%-------------------------------------------------
    [V1 | Tlv2] = Tlv1,
    Term1 = decode_integer(V1, [], [{riVer0, 0}], [2]),
    %%-------------------------------------------------
    %% attribute issuerAndSerialNumber(2)   External OTP-PUB-KEY:IssuerAndSerialNumber
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
...
enc_EncryptedContent({'EncryptedContent', Val},
		     TagIn) ->
...
enc_EncryptedContentInfo(Val, TagIn) ->
    {_, Cindex1, Cindex2, Cindex3} = Val,
    %%-------------------------------------------------
    %% attribute contentType(1)   External OTP-PUB-KEY:ContentType
    %%-------------------------------------------------
    {EncBytes1, EncLen1} = enc_ContentType(Cindex1,
					   [<<6>>]),
    %%-------------------------------------------------
    %% attribute contentEncryptionAlgorithm(2)   External OTP-PUB-KEY:ContentEncryptionAlgorithmIdentifier
    %%-------------------------------------------------
    {EncBytes2, EncLen2} =
	enc_ContentEncryptionAlgorithmIdentifier(Cindex2,
						 [<<48>>]),
    %%-------------------------------------------------
    ...
    {EncBytes3, EncLen3} = case Cindex3 of
			     asn1_NOVALUE -> {<<>>, 0};
			     _ -> encode_octet_string([], Cindex3, [<<128>>])
			   end,
    BytesSoFar = [EncBytes1, EncBytes2, EncBytes3],
    LenSoFar = EncLen1 + EncLen2 + EncLen3,
    encode_tags(TagIn, BytesSoFar, LenSoFar).
...
dec_EncryptedContentInfo(Tlv, TagIn) ->
    ...
    %%-------------------------------------------------
    [V1 | Tlv2] = Tlv1,
    Term1 = dec_ContentType(V1, [6]),
    %%-------------------------------------------------
    %% attribute contentEncryptionAlgorithm(2)   External OTP-PUB-KEY:ContentEncryptionAlgorithmIdentifier
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
    Term2 = dec_ContentEncryptionAlgorithmIdentifier(V2,
						     [16]),
    %%-------------------------------------------------
    %% attribute encryptedContent(3) with type OCTET STRING OPTIONAL
    %%-------------------------------------------------
...
%%  RecipientInfos
%%================================
enc_RecipientInfos(Val) -> enc_RecipientInfos(Val, []).

enc_RecipientInfos({'RecipientInfos', Val}, TagIn) ->
    enc_RecipientInfos(Val, TagIn);
enc_RecipientInfos(Val, TagIn) ->
    {EncBytes, EncLen} = case element(1, Val) of
			   riSet ->
			       enc_RecipientInfos_riSet(element(2, Val),
							[<<49>>]);
			   riSequence ->
			       enc_RecipientInfos_riSequence(element(2, Val),
							     [<<48>>]);
			   Else ->
			       exit({error,
				     {asn1, {invalid_choice_type, Else}}})
...
enc_RecipientInfos_riSet({'RecipientInfos_riSet', Val},
			 TagIn) ->
    enc_RecipientInfos_riSet(Val, TagIn);
enc_RecipientInfos_riSet(Val, TagIn) ->
    {EncBytes, EncLen} =
	enc_RecipientInfos_riSet_components(Val, [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_RecipientInfos_riSet_components([], AccBytes,
				    AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
enc_RecipientInfos_riSet_components([H | T], AccBytes,
				    AccLen) ->
    {EncBytes, EncLen} = enc_RecipientInfo(H, [<<48>>]),
    enc_RecipientInfos_riSet_components(T,
					[EncBytes | AccBytes], AccLen + EncLen).
...
enc_RecipientInfos_riSequence({'RecipientInfos_riSequence',
			       Val},
			      TagIn) ->
    enc_RecipientInfos_riSequence(Val, TagIn);
enc_RecipientInfos_riSequence(Val, TagIn) ->
    {EncBytes, EncLen} =
	enc_RecipientInfos_riSequence_components(Val, [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_RecipientInfos_riSequence_components([], AccBytes,
					 AccLen) ->
    {lists:reverse(AccBytes), AccLen};
enc_RecipientInfos_riSequence_components([H | T],
					 AccBytes, AccLen) ->
    {EncBytes, EncLen} = enc_RecipientInfo(H, [<<48>>]),
    enc_RecipientInfos_riSequence_components(T,
					     [EncBytes | AccBytes],
					     AccLen + EncLen).
...
dec_RecipientInfos(Tlv) -> dec_RecipientInfos(Tlv, []).
...
dec_RecipientInfos(Tlv, TagIn) ->
	...
	of
      %% 'riSet'
      {17, V1} -> {riSet, dec_RecipientInfos_riSet(V1, [])};
      %% 'riSequence'
      {16, V1} ->
...
enc_EnvelopedData(Val, TagIn) ->
    ...
    %%-------------------------------------------------
    {EncBytes3, EncLen3} = enc_EncryptedContentInfo(Cindex3,
						    [<<48>>]),
    BytesSoFar = [EncBytes1, EncBytes2, EncBytes3],
    LenSoFar = EncLen1 + EncLen2 + EncLen3,
    encode_tags(TagIn, BytesSoFar, LenSoFar).

dec_EnvelopedData(Tlv) -> dec_EnvelopedData(Tlv, [16]).
...
%%  Digest
%%================================
enc_Digest(Val) -> enc_Digest(Val, [<<4>>]).

enc_Digest({'Digest', Val}, TagIn) ->
    enc_Digest(Val, TagIn);
enc_Digest(Val, TagIn) ->
    encode_octet_string([], Val, TagIn).

dec_Digest(Tlv) -> dec_Digest(Tlv, [4]).
...
enc_EncryptedDigest({'EncryptedDigest', Val}, TagIn) ->
...
%%  SignerInfo
%%================================
enc_SignerInfo(Val) -> enc_SignerInfo(Val, [<<48>>]).
...
enc_SignerInfo(Val, TagIn) ->
    ...
    %%-------------------------------------------------
    {EncBytes3, EncLen3} =
	enc_DigestAlgorithmIdentifier(Cindex3, [<<48>>]),
    %%-------------------------------------------------
    ...
    %%-------------------------------------------------
    {EncBytes5, EncLen5} =
	enc_DigestEncryptionAlgorithmIdentifier(Cindex5,
						[<<48>>]),
    %%-------------------------------------------------
    %% attribute encryptedDigest(6) with type OCTET STRING
    %%-------------------------------------------------
    {EncBytes6, EncLen6} = encode_octet_string([], Cindex6,
					       [<<4>>]),
    %%-------------------------------------------------
...
enc_SignerInfo_authenticatedAttributes({'SignerInfo_authenticatedAttributes',
					Val},
				       TagIn) ->
...
enc_SignerInfo_authenticatedAttributes(Val, TagIn) ->
    {EncBytes, EncLen} = case element(1, Val) of
			   aaSet ->
			       enc_SignerInfo_authenticatedAttributes_aaSet(element(2,
										    Val),
									    [<<160>>]);
			   aaSequence ->
			       enc_SignerInfo_authenticatedAttributes_aaSequence(element(2,
											 Val),
										 [<<48>>,
										  <<162>>]);
			   Else ->
...
enc_SignerInfo_authenticatedAttributes_aaSet({'SignerInfo_authenticatedAttributes_aaSet',
					      Val},
					     TagIn) ->
    enc_SignerInfo_authenticatedAttributes_aaSet(Val,
						 TagIn);
enc_SignerInfo_authenticatedAttributes_aaSet(Val,
					     TagIn) ->
    {EncBytes, EncLen} =
	enc_SignerInfo_authenticatedAttributes_aaSet_components(Val,
								[], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_SignerInfo_authenticatedAttributes_aaSet_components([],
							AccBytes, AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
enc_SignerInfo_authenticatedAttributes_aaSet_components([H
							 | T],
							AccBytes, AccLen) ->
    {EncBytes, EncLen} =
	'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7'(H,
								       [<<48>>]),
    enc_SignerInfo_authenticatedAttributes_aaSet_components(T,
							    [EncBytes
							     | AccBytes],
							    AccLen + EncLen).

%%================================
%%  SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7
%%================================
'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7'(Val,
							       TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objtype =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_4(id,
							    Cindex1),
    %%-------------------------------------------------
    ...
    %%-------------------------------------------------
    {EncBytes2, EncLen2} =
	'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'(Cindex2,
									      [<<49>>],
									      Objtype),
    BytesSoFar = [EncBytes1, EncBytes2],
    LenSoFar = EncLen1 + EncLen2,
...
%%================================
%%  SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values
%%================================

'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'({'SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values',
								       Val},
								      TagIn,
								      ObjFun) ->
    'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'(Val,
									  TagIn,
									  ObjFun);
'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'(Val,
								      TagIn,
								      ObjFun) ->
    {EncBytes, EncLen} =
	'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values_components'(Val,
											 ObjFun,
											 [],
											 0),
    encode_tags(TagIn, EncBytes, EncLen).

'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values_components'([],
										 _,
										 AccBytes,
										 AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values_components'([H
										  | T],
										 ObjFun,
										 AccBytes,
										 AccLen) ->
    ...
    'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values_components'(T,
										     ObjFun,
										     [EncBytes
										      | AccBytes],
										     AccLen
...
'dec_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'(Tlv,
								      TagIn,
								      ObjFun) ->
    %%-------------------------------------------------
    %% decode tag and length
...
'dec_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7'(Tlv,
							       TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    ...
    Term1 = decode_object_identifier(V1, [6]),
    ObjFun =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_4(id,
							    Term1),
    %%-------------------------------------------------
    %% attribute values(2) with type SET OF
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
    Term2 =
	'dec_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'(V2,
									      [17],
									      ObjFun),
    case Tlv3 of
      [] -> true;
...
dec_SignerInfo_authenticatedAttributes_aaSet(Tlv,
					     TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    Tlv1 = match_tags(Tlv, TagIn),
    ['dec_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7'(V1,
								    [16])
     || V1 <- Tlv1].
...
enc_SignerInfo_authenticatedAttributes_aaSequence({'SignerInfo_authenticatedAttributes_aaSequence',
						   Val},
						  TagIn) ->
    enc_SignerInfo_authenticatedAttributes_aaSequence(Val,
						      TagIn);
enc_SignerInfo_authenticatedAttributes_aaSequence(Val,
						  TagIn) ->
    {EncBytes, EncLen} =
	enc_SignerInfo_authenticatedAttributes_aaSequence_components(Val,
								     [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_SignerInfo_authenticatedAttributes_aaSequence_components([],
							     AccBytes,
							     AccLen) ->
    {lists:reverse(AccBytes), AccLen};
enc_SignerInfo_authenticatedAttributes_aaSequence_components([H
							      | T],
							     AccBytes,
							     AccLen) ->
    {EncBytes, EncLen} =
	'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7'(H,
									    [<<48>>]),
    enc_SignerInfo_authenticatedAttributes_aaSequence_components(T,
								 [EncBytes
								  | AccBytes],
								 AccLen +
								   EncLen).
...
%%================================
%%  SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7
%%================================
'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7'(Val,
								    TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objtype =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_5(id,
							    Cindex1),
    %%-------------------------------------------------
    %% attribute type(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
    ...
    %%-------------------------------------------------
    {EncBytes2, EncLen2} =
	'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'(Cindex2,
										   [<<49>>],
										   Objtype),
    BytesSoFar = [EncBytes1, EncBytes2],
    LenSoFar = EncLen1 + EncLen2,
...
%%================================
%%  SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values
%%================================

'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'({'SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values',
									    Val},
									   TagIn,
									   ObjFun) ->
    'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'(Val,
									       TagIn,
									       ObjFun);
'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'(Val,
									   TagIn,
									   ObjFun) ->
    {EncBytes, EncLen} =
	'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values_components'(Val,
											      ObjFun,
											      [],
											      0),
    encode_tags(TagIn, EncBytes, EncLen).

'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values_components'([],
										      _,
										      AccBytes,
										      AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values_components'([H
										       | T],
										      ObjFun,
										      AccBytes,
										      AccLen) ->
    {TmpBytes1, _} = ObjFun('Type', H, []),
    {EncBytes, EncLen} = encode_open_type(TmpBytes1, []),
    'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values_components'(T,
											  ObjFun,
											  [EncBytes
											   | AccBytes],
											  AccLen
...
'dec_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'(Tlv,
									   TagIn,
									   ObjFun) ->
    %%-------------------------------------------------
    %% decode tag and length
...
'dec_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7'(Tlv,
								    TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    ...
    Term1 = decode_object_identifier(V1, [6]),
    ObjFun =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_5(id,
							    Term1),
    %%-------------------------------------------------
    %% attribute values(2) with type SET OF
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
    Term2 =
	'dec_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'(V2,
										   [17],
										   ObjFun),
    case Tlv3 of
      [] -> true;
...
dec_SignerInfo_authenticatedAttributes_aaSequence(Tlv,
						  TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    Tlv1 = match_tags(Tlv, TagIn),
    ['dec_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7'(V1,
									 [16])
     || V1 <- Tlv1].
...
dec_SignerInfo_authenticatedAttributes(Tlv, TagIn) ->
	...
	of
      ...
      {131072, V1} ->
	  {aaSet,
	   dec_SignerInfo_authenticatedAttributes_aaSet(V1, [])};
      %% 'aaSequence'
      {131074, V1} ->
	  {aaSequence,
	   dec_SignerInfo_authenticatedAttributes_aaSequence(V1,
							     [16])};
      Else ->
	  exit({error, {asn1, {invalid_choice_tag, Else}}})
    end.
...
enc_SignerInfo_unauthenticatedAttributes({'SignerInfo_unauthenticatedAttributes',
					  Val},
					 TagIn) ->
...
enc_SignerInfo_unauthenticatedAttributes(Val, TagIn) ->
    {EncBytes, EncLen} = case element(1, Val) of
			   uaSet ->
			       enc_SignerInfo_unauthenticatedAttributes_uaSet(element(2,
										      Val),
									      [<<161>>]);
			   uaSequence ->
			       enc_SignerInfo_unauthenticatedAttributes_uaSequence(element(2,
											   Val),
										   [<<163>>]);
			   Else ->
			       exit({error,
...
enc_SignerInfo_unauthenticatedAttributes_uaSet({'SignerInfo_unauthenticatedAttributes_uaSet',
						Val},
					       TagIn) ->
    enc_SignerInfo_unauthenticatedAttributes_uaSet(Val,
						   TagIn);
enc_SignerInfo_unauthenticatedAttributes_uaSet(Val,
					       TagIn) ->
    {EncBytes, EncLen} =
	enc_SignerInfo_unauthenticatedAttributes_uaSet_components(Val,
								  [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_SignerInfo_unauthenticatedAttributes_uaSet_components([],
							  AccBytes, AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
enc_SignerInfo_unauthenticatedAttributes_uaSet_components([H
							   | T],
							  AccBytes, AccLen) ->
    {EncBytes, EncLen} =
	'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7'(H,
									 [<<48>>]),
    enc_SignerInfo_unauthenticatedAttributes_uaSet_components(T,
							      [EncBytes
							       | AccBytes],
							      AccLen + EncLen).
...
%%================================
'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7'(Val,
								 TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objtype =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_7(id,
							    Cindex1),
    %%-------------------------------------------------
    %% attribute type(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
    ...
    %%-------------------------------------------------
    {EncBytes2, EncLen2} =
	'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values'(Cindex2,
										[<<49>>],
										Objtype),
    BytesSoFar = [EncBytes1, EncBytes2],
    LenSoFar = EncLen1 + EncLen2,
...
'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values'({'SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values',
									 Val},
									TagIn,
									ObjFun) ->
    'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values'(Val,
									    TagIn,
									    ObjFun);
'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values'(Val,
									TagIn,
									ObjFun) ->
    {EncBytes, EncLen} =
	'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values_components'(Val,
											   ObjFun,
											   [],
											   0),
    encode_tags(TagIn, EncBytes, EncLen).

'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values_components'([],
										   _,
										   AccBytes,
										   AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values_components'([H
										    | T],
										   ObjFun,
										   AccBytes,
										   AccLen) ->
    {TmpBytes1, _} = ObjFun('Type', H, []),
    {EncBytes, EncLen} = encode_open_type(TmpBytes1, []),
    'enc_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values_components'(T,
										       ObjFun,
										       [EncBytes
											| AccBytes],
										       AccLen
...
'dec_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values'(Tlv,
									TagIn,
									ObjFun) ->
    %%-------------------------------------------------
    %% decode tag and length
...
'dec_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7'(Tlv,
								 TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    ...
    Term1 = decode_object_identifier(V1, [6]),
    ObjFun =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_7(id,
							    Term1),
    %%-------------------------------------------------
    %% attribute values(2) with type SET OF
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
    Term2 =
	'dec_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7_values'(V2,
										[17],
										ObjFun),
    case Tlv3 of
      [] -> true;
...
dec_SignerInfo_unauthenticatedAttributes_uaSet(Tlv,
					       TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    Tlv1 = match_tags(Tlv, TagIn),
    ['dec_SignerInfo_unauthenticatedAttributes_uaSet_AttributePKCS-7'(V1,
								      [16])
     || V1 <- Tlv1].
...
enc_SignerInfo_unauthenticatedAttributes_uaSequence({'SignerInfo_unauthenticatedAttributes_uaSequence',
						     Val},
						    TagIn) ->
    enc_SignerInfo_unauthenticatedAttributes_uaSequence(Val,
							TagIn);
enc_SignerInfo_unauthenticatedAttributes_uaSequence(Val,
						    TagIn) ->
    {EncBytes, EncLen} =
	enc_SignerInfo_unauthenticatedAttributes_uaSequence_components(Val,
								       [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_SignerInfo_unauthenticatedAttributes_uaSequence_components([],
							       AccBytes,
							       AccLen) ->
    {lists:reverse(AccBytes), AccLen};
enc_SignerInfo_unauthenticatedAttributes_uaSequence_components([H
								| T],
							       AccBytes,
							       AccLen) ->
    {EncBytes, EncLen} =
	'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7'(H,
									      [<<48>>]),
    enc_SignerInfo_unauthenticatedAttributes_uaSequence_components(T,
								   [EncBytes
								    | AccBytes],
								   AccLen +
								     EncLen).
...
%%================================
'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7'(Val,
								      TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objtype =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_8(id,
							    Cindex1),
    %%-------------------------------------------------
    %% attribute type(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
    ...
    %%-------------------------------------------------
    {EncBytes2, EncLen2} =
	'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values'(Cindex2,
										     [<<49>>],
										     Objtype),
    BytesSoFar = [EncBytes1, EncBytes2],
    LenSoFar = EncLen1 + EncLen2,
...
'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values'({'SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values',
									      Val},
									     TagIn,
									     ObjFun) ->
    'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values'(Val,
										 TagIn,
										 ObjFun);
'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values'(Val,
									     TagIn,
									     ObjFun) ->
    {EncBytes, EncLen} =
	'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values_components'(Val,
												ObjFun,
												[],
												0),
    encode_tags(TagIn, EncBytes, EncLen).

'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values_components'([],
											_,
											AccBytes,
											AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values_components'([H
											 | T],
											ObjFun,
											AccBytes,
											AccLen) ->
    {TmpBytes1, _} = ObjFun('Type', H, []),
    {EncBytes, EncLen} = encode_open_type(TmpBytes1, []),
    'enc_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values_components'(T,
											    ObjFun,
											    [EncBytes
											     | AccBytes],
											    AccLen
...
'dec_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values'(Tlv,
									     TagIn,
									     ObjFun) ->
    %%-------------------------------------------------
    %% decode tag and length
...
'dec_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7'(Tlv,
								      TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    ...
    Term1 = decode_object_identifier(V1, [6]),
    ObjFun =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_8(id,
							    Term1),
    %%-------------------------------------------------
    %% attribute values(2) with type SET OF
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
    Term2 =
	'dec_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7_values'(V2,
										     [17],
										     ObjFun),
    case Tlv3 of
      [] -> true;
...
dec_SignerInfo_unauthenticatedAttributes_uaSequence(Tlv,
						    TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    Tlv1 = match_tags(Tlv, TagIn),
    ['dec_SignerInfo_unauthenticatedAttributes_uaSequence_AttributePKCS-7'(V1,
									   [16])
     || V1 <- Tlv1].
...
dec_SignerInfo_unauthenticatedAttributes(Tlv, TagIn) ->
	...
	of
      ...
      {131073, V1} ->
	  {uaSet,
	   dec_SignerInfo_unauthenticatedAttributes_uaSet(V1, [])};
      %% 'uaSequence'
      {131075, V1} ->
	  {uaSequence,
	   dec_SignerInfo_unauthenticatedAttributes_uaSequence(V1,
							       [])};
      Else ->
	  exit({error, {asn1, {invalid_choice_tag, Else}}})
    end.

dec_SignerInfo(Tlv) -> dec_SignerInfo(Tlv, [16]).
...
dec_SignerInfo(Tlv, TagIn) ->
    ...
    {Term4, Tlv5} = case Tlv4 of
			  ...
			  {dec_SignerInfo_authenticatedAttributes(V4, []),
			   TempTlv5};
    ...
    %%-------------------------------------------------
    [V5 | Tlv6] = Tlv5,
    Term5 = dec_DigestEncryptionAlgorithmIdentifier(V5,
						    [16]),
    %%-------------------------------------------------
    %% attribute encryptedDigest(6) with type OCTET STRING
    %%-------------------------------------------------
    ...
    {Term7, Tlv8} = case Tlv7 of
			  ...
			  {dec_SignerInfo_unauthenticatedAttributes(V7, []),
			   TempTlv8};
    ...
    {'SignerInfo', Term1, Term2, Term3, Term4, Term5, Term6,
     Term7}.
...
enc_DigestAlgorithmIdentifiers({'DigestAlgorithmIdentifiers',
				Val},
			       TagIn) ->
...
enc_DigestAlgorithmIdentifiers(Val, TagIn) ->
    {EncBytes, EncLen} = case element(1, Val) of
			   daSet ->
			       enc_DigestAlgorithmIdentifiers_daSet(element(2,
									    Val),
								    [<<49>>]);
			   daSequence ->
			       enc_DigestAlgorithmIdentifiers_daSequence(element(2,
										 Val),
									 [<<48>>]);
			   Else ->
			       exit({error,
...
enc_DigestAlgorithmIdentifiers_daSet({'DigestAlgorithmIdentifiers_daSet',
				      Val},
				     TagIn) ->
    enc_DigestAlgorithmIdentifiers_daSet(Val, TagIn);
enc_DigestAlgorithmIdentifiers_daSet(Val, TagIn) ->
    {EncBytes, EncLen} =
	enc_DigestAlgorithmIdentifiers_daSet_components(Val, [],
							0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_DigestAlgorithmIdentifiers_daSet_components([],
						AccBytes, AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
enc_DigestAlgorithmIdentifiers_daSet_components([H | T],
						AccBytes, AccLen) ->
    {EncBytes, EncLen} = enc_DigestAlgorithmIdentifier(H,
						       [<<48>>]),
    enc_DigestAlgorithmIdentifiers_daSet_components(T,
						    [EncBytes | AccBytes],
						    AccLen + EncLen).
...
enc_DigestAlgorithmIdentifiers_daSequence({'DigestAlgorithmIdentifiers_daSequence',
					   Val},
					  TagIn) ->
    enc_DigestAlgorithmIdentifiers_daSequence(Val, TagIn);
enc_DigestAlgorithmIdentifiers_daSequence(Val, TagIn) ->
    {EncBytes, EncLen} =
	enc_DigestAlgorithmIdentifiers_daSequence_components(Val,
							     [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_DigestAlgorithmIdentifiers_daSequence_components([],
						     AccBytes, AccLen) ->
    {lists:reverse(AccBytes), AccLen};
enc_DigestAlgorithmIdentifiers_daSequence_components([H
						      | T],
						     AccBytes, AccLen) ->
    {EncBytes, EncLen} = enc_DigestAlgorithmIdentifier(H,
						       [<<48>>]),
    enc_DigestAlgorithmIdentifiers_daSequence_components(T,
							 [EncBytes | AccBytes],
							 AccLen + EncLen).
...
dec_DigestAlgorithmIdentifiers(Tlv, TagIn) ->
	...
	of
      ...
      {16, V1} ->
	  {daSequence,
	   dec_DigestAlgorithmIdentifiers_daSequence(V1, [])};
      Else ->
	  exit({error, {asn1, {invalid_choice_tag, Else}}})
    end.
...
%%  SignerInfos
%%================================
enc_SignerInfos(Val) -> enc_SignerInfos(Val, []).

enc_SignerInfos({'SignerInfos', Val}, TagIn) ->
...
enc_SignerInfos(Val, TagIn) ->
    {EncBytes, EncLen} = case element(1, Val) of
			   ...
			   siSequence ->
			       enc_SignerInfos_siSequence(element(2, Val),
							  [<<48>>]);
			   Else ->
			       exit({error,
				     {asn1, {invalid_choice_type, Else}}})
...
enc_SignerInfos_siSet({'SignerInfos_siSet', Val},
		      TagIn) ->
    enc_SignerInfos_siSet(Val, TagIn);
enc_SignerInfos_siSet(Val, TagIn) ->
    {EncBytes, EncLen} =
	enc_SignerInfos_siSet_components(Val, [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_SignerInfos_siSet_components([], AccBytes,
				 AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
enc_SignerInfos_siSet_components([H | T], AccBytes,
				 AccLen) ->
    {EncBytes, EncLen} = enc_SignerInfo(H, [<<48>>]),
    enc_SignerInfos_siSet_components(T,
				     [EncBytes | AccBytes], AccLen + EncLen).
...
enc_SignerInfos_siSequence({'SignerInfos_siSequence',
			    Val},
			   TagIn) ->
    enc_SignerInfos_siSequence(Val, TagIn);
enc_SignerInfos_siSequence(Val, TagIn) ->
    {EncBytes, EncLen} =
	enc_SignerInfos_siSequence_components(Val, [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_SignerInfos_siSequence_components([], AccBytes,
				      AccLen) ->
    {lists:reverse(AccBytes), AccLen};
enc_SignerInfos_siSequence_components([H | T], AccBytes,
				      AccLen) ->
    {EncBytes, EncLen} = enc_SignerInfo(H, [<<48>>]),
    enc_SignerInfos_siSequence_components(T,
					  [EncBytes | AccBytes],
					  AccLen + EncLen).
...
dec_SignerInfos(Tlv) -> dec_SignerInfos(Tlv, []).
...
dec_SignerInfos(Tlv, TagIn) ->
	...
	of
      %% 'siSet'
      {17, V1} -> {siSet, dec_SignerInfos_siSet(V1, [])};
      %% 'siSequence'
      {16, V1} ->
...
%%  SignedData
%%================================
enc_SignedData(Val) -> enc_SignedData(Val, [<<48>>]).
...
enc_SignedData(Val, TagIn) ->
    ...
    %%-------------------------------------------------
    {EncBytes2, EncLen2} =
	enc_DigestAlgorithmIdentifiers(Cindex2, []),
    %%-------------------------------------------------
    %% attribute contentInfo(3)   External OTP-PUB-KEY:ContentInfo
    %%-------------------------------------------------
    {EncBytes3, EncLen3} = enc_ContentInfo(Cindex3,
    ...
    {EncBytes4, EncLen4} = case Cindex4 of
			     asn1_NOVALUE -> {<<>>, 0};
			     _ -> enc_SignedData_certificates(Cindex4, [])
			   end,
    %%-------------------------------------------------
...
enc_SignedData_certificates({'SignedData_certificates',
			     Val},
			    TagIn) ->
...
enc_SignedData_crls({'SignedData_crls', Val}, TagIn) ->
...
dec_SignedData(Tlv) -> dec_SignedData(Tlv, [16]).
...
dec_SignedData(Tlv, TagIn) ->
    ...
    {'SignedData', Term1, Term2, Term3, Term4, Term5,
     Term6}.

%%================================
%%  Data
%%================================
enc_Data(Val) -> enc_Data(Val, [<<4>>]).

enc_Data({'Data', Val}, TagIn) -> enc_Data(Val, TagIn);
enc_Data(Val, TagIn) ->
    encode_octet_string([], Val, TagIn).

dec_Data(Tlv) -> dec_Data(Tlv, [4]).
...
%%  ContentType
%%================================
enc_ContentType(Val) -> enc_ContentType(Val, [<<6>>]).

enc_ContentType({'ContentType', Val}, TagIn) ->
    enc_ContentType(Val, TagIn);
enc_ContentType(Val, TagIn) ->
    encode_object_identifier(Val, TagIn).

dec_ContentType(Tlv) -> dec_ContentType(Tlv, [6]).
...
%%  ContentInfo
%%================================
enc_ContentInfo(Val) -> enc_ContentInfo(Val, [<<48>>]).

enc_ContentInfo(Val, TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    ObjcontentType = 'OTP-PUB-KEY':getenc_Contents(id,
						   Cindex1),
    %%-------------------------------------------------
    %% attribute contentType(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
    {EncBytes1, EncLen1} = encode_object_identifier(Cindex1,
						    [<<6>>]),
    %%-------------------------------------------------
    ...
    {EncBytes2, EncLen2} = case Cindex2 of
			     asn1_NOVALUE -> {<<>>, 0};
			     _ ->
				 {TmpBytes, _} = ObjcontentType('Type', Cindex2,
								[]),
				 {TmpBytes1, TmpLen} =
				     encode_open_type(TmpBytes, [<<160>>]),
				 {TmpBytes1, TmpLen}
			   end,
    BytesSoFar = [EncBytes1, EncBytes2],
    LenSoFar = EncLen1 + EncLen2,
...
dec_ContentInfo(Tlv) -> dec_ContentInfo(Tlv, [16]).
...
dec_ContentInfo(Tlv, TagIn) ->
	...
	'OTP-PUB-KEY':getdec_Contents(id, Term1),
    Term2 = case Tmpterm1 of
	      asn1_NOVALUE -> asn1_NOVALUE;
	      _ ->
		  case catch DecObjcontentTypeTerm1('Type', Tmpterm1, [])
		      of
		    {'EXIT', Reason1} ->
...
enc_KeyEncryptionAlgorithmIdentifier(Val, TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objalgorithm =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_3(id,
							    Cindex1),
    %%-------------------------------------------------
...
dec_KeyEncryptionAlgorithmIdentifier(Tlv, TagIn) ->
	...
	'OTP-PUB-KEY':getdec_internal_object_set_argument_3(id,
							    Term1),
    Term2 = case Tmpterm1 of
	      asn1_NOVALUE -> asn1_NOVALUE;
	      _ ->
...
enc_ExtendedCertificatesAndCertificates({'ExtendedCertificatesAndCertificates',
					 Val},
					TagIn) ->
    enc_ExtendedCertificatesAndCertificates(Val, TagIn);
enc_ExtendedCertificatesAndCertificates(Val, TagIn) ->
    {EncBytes, EncLen} =
	enc_ExtendedCertificatesAndCertificates_components(Val,
							   [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_ExtendedCertificatesAndCertificates_components([],
						   AccBytes, AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
enc_ExtendedCertificatesAndCertificates_components([H
						    | T],
						   AccBytes, AccLen) ->
    {EncBytes, EncLen} =
	enc_ExtendedCertificateOrCertificate(H, []),
    enc_ExtendedCertificatesAndCertificates_components(T,
						       [EncBytes | AccBytes],
						       AccLen + EncLen).
...
enc_ExtendedCertificate({'ExtendedCertificate', Val},
			TagIn) ->
...
enc_ExtendedCertificateOrCertificate({'ExtendedCertificateOrCertificate',
				      Val},
				     TagIn) ->
...
enc_ExtendedCertificateOrCertificate(Val, TagIn) ->
    {EncBytes, EncLen} = case element(1, Val) of
			   ...
			   extendedCertificate ->
			       enc_ExtendedCertificate(element(2, Val),
						       [<<160>>]);
			   Else ->
			       exit({error,
				     {asn1, {invalid_choice_type, Else}}})
...
dec_ExtendedCertificateOrCertificate(Tlv, TagIn) ->
	...
	of
      %% 'certificate'
      {16, V1} -> {certificate, dec_Certificate(V1, [])};
      %% 'extendedCertificate'
      {131072, V1} ->
...
enc_DigestEncryptionAlgorithmIdentifier(Val, TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objalgorithm =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_6(id,
							    Cindex1),
    %%-------------------------------------------------
    %% attribute algorithm(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
...
dec_DigestEncryptionAlgorithmIdentifier(Tlv, TagIn) ->
    ...
    DecObjalgorithmTerm1 =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_6(id,
							    Term1),
    Term2 = case Tmpterm1 of
	      asn1_NOVALUE -> asn1_NOVALUE;
	      _ ->
...
enc_DigestAlgorithmIdentifier(Val, TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objalgorithm =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_2(id,
							    Cindex1),
    %%-------------------------------------------------
    %% attribute algorithm(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
...
dec_DigestAlgorithmIdentifier(Tlv, TagIn) ->
    ...
    DecObjalgorithmTerm1 =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_2(id,
							    Term1),
    Term2 = case Tmpterm1 of
	      asn1_NOVALUE -> asn1_NOVALUE;
	      _ ->
...
enc_ContentEncryptionAlgorithmIdentifier(Val, TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objalgorithm =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_1(id,
							    Cindex1),
    %%-------------------------------------------------
    %% attribute algorithm(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
...
dec_ContentEncryptionAlgorithmIdentifier(Tlv, TagIn) ->
    ...
    DecObjalgorithmTerm1 =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_1(id,
							    Term1),
    Term2 = case Tmpterm1 of
	      asn1_NOVALUE -> asn1_NOVALUE;
	      _ ->
...
%%  CRLSequence
%%================================
enc_CRLSequence(Val) -> enc_CRLSequence(Val, [<<48>>]).

enc_CRLSequence({'CRLSequence', Val}, TagIn) ->
    enc_CRLSequence(Val, TagIn);
enc_CRLSequence(Val, TagIn) ->
    {EncBytes, EncLen} = enc_CRLSequence_components(Val, [],
						    0),
    encode_tags(TagIn, EncBytes, EncLen).
...
enc_CRLSequence_components([H | T], AccBytes, AccLen) ->
    ...
    enc_CRLSequence_components(T, [EncBytes | AccBytes],
			       AccLen + EncLen).

dec_CRLSequence(Tlv) -> dec_CRLSequence(Tlv, [16]).
...
enc_Certificates({'Certificates', Val}, TagIn) ->
    enc_Certificates(Val, TagIn);
enc_Certificates(Val, TagIn) ->
    {EncBytes, EncLen} = enc_Certificates_components(Val,
						     [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_Certificates_components([], AccBytes, AccLen) ->
    {lists:reverse(AccBytes), AccLen};
enc_Certificates_components([H | T], AccBytes,
			    AccLen) ->
    {EncBytes, EncLen} = enc_Certificate(H, [<<48>>]),
    enc_Certificates_components(T, [EncBytes | AccBytes],
				AccLen + EncLen).

dec_Certificates(Tlv) -> dec_Certificates(Tlv, [16]).
...
enc_CertificateRevocationLists({'CertificateRevocationLists',
				Val},
			       TagIn) ->
    enc_CertificateRevocationLists(Val, TagIn);
enc_CertificateRevocationLists(Val, TagIn) ->
    {EncBytes, EncLen} =
	enc_CertificateRevocationLists_components(Val, [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_CertificateRevocationLists_components([], AccBytes,
					  AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
enc_CertificateRevocationLists_components([H | T],
					  AccBytes, AccLen) ->
    {EncBytes, EncLen} = enc_CertificateList(H, [<<48>>]),
    enc_CertificateRevocationLists_components(T,
					      [EncBytes | AccBytes],
					      AccLen + EncLen).
...
%%  SigningTime
%%================================
enc_SigningTime(Val) -> enc_SigningTime(Val, []).

enc_SigningTime({'SigningTime', Val}, TagIn) ->
    enc_SigningTime(Val, TagIn);
enc_SigningTime(Val, TagIn) -> enc_Time(Val, TagIn).

dec_SigningTime(Tlv) -> dec_SigningTime(Tlv, []).

dec_SigningTime(Tlv, TagIn) -> dec_Time(Tlv, TagIn).
...
enc_MessageDigest({'MessageDigest', Val}, TagIn) ->
    enc_MessageDigest(Val, TagIn);
enc_MessageDigest(Val, TagIn) ->
    encode_octet_string([], Val, TagIn).

dec_MessageDigest(Tlv) -> dec_MessageDigest(Tlv, [4]).
...
enc_CertificationRequest(Val, TagIn) ->
    ...
    %%-------------------------------------------------
    {EncBytes1, EncLen1} =
	enc_CertificationRequestInfo(Cindex1, [<<48>>]),
    %%-------------------------------------------------
    %% attribute signatureAlgorithm(2) with type SEQUENCE
    %%-------------------------------------------------
    {EncBytes2, EncLen2} =
	enc_CertificationRequest_signatureAlgorithm(Cindex2,
						    [<<48>>]),
    %%-------------------------------------------------
...
%%================================
enc_CertificationRequest_signatureAlgorithm(Val,
					    TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objalgorithm =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_11(id,
							     Cindex1),
    %%-------------------------------------------------
    %% attribute algorithm(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
...
dec_CertificationRequest_signatureAlgorithm(Tlv,
					    TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    ...
    DecObjalgorithmTerm1 =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_11(id,
							     Term1),
    Term2 = case Tmpterm1 of
	      asn1_NOVALUE -> asn1_NOVALUE;
	      _ ->
    ...
    {'CertificationRequest_signatureAlgorithm', Term1,
     Term2}.
...
dec_CertificationRequest(Tlv, TagIn) ->
    ...
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
    Term2 = dec_CertificationRequest_signatureAlgorithm(V2,
							[16]),
    %%-------------------------------------------------
    %% attribute signature(3) with type BIT STRING
    %%-------------------------------------------------
...
enc_CertificationRequestInfo(Val, TagIn) ->
    ...
    %%-------------------------------------------------
    {EncBytes3, EncLen3} =
	enc_CertificationRequestInfo_subjectPKInfo(Cindex3,
						   [<<48>>]),
    %%-------------------------------------------------
    %% attribute attributes(4) with type SET OF
    %%-------------------------------------------------
    {EncBytes4, EncLen4} =
	enc_CertificationRequestInfo_attributes(Cindex4,
						[<<160>>]),
    BytesSoFar = [EncBytes1, EncBytes2, EncBytes3,
		  EncBytes4],
    LenSoFar = EncLen1 + EncLen2 + EncLen3 + EncLen4,
...
%%================================
enc_CertificationRequestInfo_subjectPKInfo(Val,
					   TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    %%-------------------------------------------------
    ...
    %%-------------------------------------------------
    {EncBytes1, EncLen1} =
	enc_CertificationRequestInfo_subjectPKInfo_algorithm(Cindex1,
							     [<<48>>]),
    %%-------------------------------------------------
...
%%================================
enc_CertificationRequestInfo_subjectPKInfo_algorithm(Val,
						     TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objalgorithm =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_9(id,
							    Cindex1),
    %%-------------------------------------------------
    %% attribute algorithm(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
...
dec_CertificationRequestInfo_subjectPKInfo_algorithm(Tlv,
						     TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    ...
    DecObjalgorithmTerm1 =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_9(id,
							    Term1),
    Term2 = case Tmpterm1 of
	      asn1_NOVALUE -> asn1_NOVALUE;
	      _ ->
...
dec_CertificationRequestInfo_subjectPKInfo(Tlv,
					   TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    ...
    [V1 | Tlv2] = Tlv1,
    Term1 =
	dec_CertificationRequestInfo_subjectPKInfo_algorithm(V1,
							     [16]),
    %%-------------------------------------------------
    %% attribute subjectPublicKey(2) with type BIT STRING
    %%-------------------------------------------------
    ...
    {'CertificationRequestInfo_subjectPKInfo', Term1,
     Term2}.
...
enc_CertificationRequestInfo_attributes({'CertificationRequestInfo_attributes',
					 Val},
					TagIn) ->
    enc_CertificationRequestInfo_attributes(Val, TagIn);
enc_CertificationRequestInfo_attributes(Val, TagIn) ->
    {EncBytes, EncLen} =
	enc_CertificationRequestInfo_attributes_components(Val,
							   [], 0),
    encode_tags(TagIn, EncBytes, EncLen).

enc_CertificationRequestInfo_attributes_components([],
						   AccBytes, AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
enc_CertificationRequestInfo_attributes_components([H
						    | T],
						   AccBytes, AccLen) ->
    {EncBytes, EncLen} =
	'enc_CertificationRequestInfo_attributes_AttributePKCS-10'(H,
								   [<<48>>]),
    enc_CertificationRequestInfo_attributes_components(T,
						       [EncBytes | AccBytes],
						       AccLen + EncLen).
...
%%================================
'enc_CertificationRequestInfo_attributes_AttributePKCS-10'(Val,
							   TagIn) ->
    {_, Cindex1, Cindex2} = Val,
    Objtype =
	'OTP-PUB-KEY':getenc_internal_object_set_argument_10(id,
							     Cindex1),
    %%-------------------------------------------------
    %% attribute type(1) with type fixedtypevaluefieldidtypetagUNIVERSAL6IMPLICIT0OBJECT IDENTIFIERno
    %%-------------------------------------------------
    ...
    %%-------------------------------------------------
    {EncBytes2, EncLen2} =
	'enc_CertificationRequestInfo_attributes_AttributePKCS-10_values'(Cindex2,
									  [<<49>>],
									  Objtype),
    BytesSoFar = [EncBytes1, EncBytes2],
    LenSoFar = EncLen1 + EncLen2,
...
'enc_CertificationRequestInfo_attributes_AttributePKCS-10_values'({'CertificationRequestInfo_attributes_AttributePKCS-10_values',
								   Val},
								  TagIn,
								  ObjFun) ->
    'enc_CertificationRequestInfo_attributes_AttributePKCS-10_values'(Val,
								      TagIn,
								      ObjFun);
'enc_CertificationRequestInfo_attributes_AttributePKCS-10_values'(Val,
								  TagIn,
								  ObjFun) ->
    {EncBytes, EncLen} =
	'enc_CertificationRequestInfo_attributes_AttributePKCS-10_values_components'(Val,
										     ObjFun,
										     [],
										     0),
    encode_tags(TagIn, EncBytes, EncLen).

'enc_CertificationRequestInfo_attributes_AttributePKCS-10_values_components'([],
									     _,
									     AccBytes,
									     AccLen) ->
    {dynamicsort_SETOF(AccBytes), AccLen};
'enc_CertificationRequestInfo_attributes_AttributePKCS-10_values_components'([H
									      | T],
									     ObjFun,
									     AccBytes,
									     AccLen) ->
    {TmpBytes1, _} = ObjFun('Type', H, []),
    {EncBytes, EncLen} = encode_open_type(TmpBytes1, []),
    'enc_CertificationRequestInfo_attributes_AttributePKCS-10_values_components'(T,
										 ObjFun,
										 [EncBytes
										  | AccBytes],
										 AccLen
...
'dec_CertificationRequestInfo_attributes_AttributePKCS-10_values'(Tlv,
								  TagIn,
								  ObjFun) ->
    %%-------------------------------------------------
    %% decode tag and length
...
'dec_CertificationRequestInfo_attributes_AttributePKCS-10'(Tlv,
							   TagIn) ->
    %%-------------------------------------------------
    %% decode tag and length
    %%-------------------------------------------------
    ...
    Term1 = decode_object_identifier(V1, [6]),
    ObjFun =
	'OTP-PUB-KEY':getdec_internal_object_set_argument_10(id,
							     Term1),
    %%-------------------------------------------------
    %% attribute values(2) with type SET OF
    %%-------------------------------------------------
    [V2 | Tlv3] = Tlv2,
    Term2 =
	'dec_CertificationRequestInfo_attributes_AttributePKCS-10_values'(V2,
									  [17],
									  ObjFun),
    case Tlv3 of
      [] -> true;
...
dec_CertificationRequestInfo_attributes(Tlv, TagIn) ->
    ...
    %%-------------------------------------------------
    Tlv1 = match_tags(Tlv, TagIn),
    ['dec_CertificationRequestInfo_attributes_AttributePKCS-10'(V1,
								[16])
     || V1 <- Tlv1].
...
dec_CertificationRequestInfo(Tlv, TagIn) ->
    ...
    %%-------------------------------------------------
    [V3 | Tlv4] = Tlv3,
    Term3 = dec_CertificationRequestInfo_subjectPKInfo(V3,
						       [16]),
    %%-------------------------------------------------
    %% attribute attributes(4) with type SET OF
    %%-------------------------------------------------
    [V4 | Tlv5] = Tlv4,
    Term4 = dec_CertificationRequestInfo_attributes(V4,
						    [131072]),
    case Tlv5 of
      [] -> true;
      _ ->
    ...
    {'CertificationRequestInfo', Term1, Term2, Term3,
     Term4}.
...
'enc_OTP-X520countryname'({'OTP-X520countryname', Val},
			  TagIn) ->
...
enc_signingTime(derivation, _, _) ->
    exit({error,
	  {'use of missing field in object', derivation}});
enc_signingTime('Type', Val, _RestPrimFieldName) ->
    enc_SigningTime(Val, []);
enc_signingTime('equality-match', _, _) ->
    exit({error,
	  {'use of missing field in object', 'equality-match'}});
enc_signingTime('ordering-match', _, _) ->
    exit({error,
	  {'use of missing field in object', 'ordering-match'}});
enc_signingTime('substrings-match', _, _) ->
    exit({error,
	  {'use of missing field in object',
	   'substrings-match'}}).

dec_signingTime(derivation, _, _) ->
    exit({error,
	  {'illegal use of missing field in object',
	   derivation}});
dec_signingTime('Type', Bytes, _) ->
    Tlv = tlv_format(Bytes), dec_SigningTime(Tlv, []);
...
dec_messageDigest('Type', Bytes, _) ->
    Tlv = tlv_format(Bytes), dec_MessageDigest(Tlv, [4]);
...
dec_counterSignature('Type', Bytes, _) ->
    Tlv = tlv_format(Bytes), dec_SignerInfo(Tlv, [16]);
...
dec_contentType('Type', Bytes, _) ->
    Tlv = tlv_format(Bytes), dec_ContentType(Tlv, [6]);
...
%%  Contents
%%================================
getenc_Contents(id, {1, 2, 840, 113549, 1, 7, 1}) ->
    fun (Type, Val, _RestPrimFieldName) ->
	    case Type of 'Type' -> enc_Data(Val) end
    end;
getenc_Contents(id, {1, 2, 840, 113549, 1, 7, 2}) ->
    fun (Type, Val, _RestPrimFieldName) ->
	    case Type of 'Type' -> enc_SignedData(Val) end
    end;
getenc_Contents(id, {1, 2, 840, 113549, 1, 7, 3}) ->
    fun (Type, Val, _RestPrimFieldName) ->
	    case Type of 'Type' -> enc_EnvelopedData(Val) end
    end;
getenc_Contents(id, {1, 2, 840, 113549, 1, 7, 4}) ->
    fun (Type, Val, _RestPrimFieldName) ->
	    case Type of
	      'Type' -> enc_SignedAndEnvelopedData(Val)
	    end
    end;
getenc_Contents(id, {1, 2, 840, 113549, 1, 7, 5}) ->
    fun (Type, Val, _RestPrimFieldName) ->
	    case Type of 'Type' -> enc_DigestedData(Val) end
    end;
getenc_Contents(id, {1, 2, 840, 113549, 1, 7, 6}) ->
    fun (Type, Val, _RestPrimFieldName) ->
	    case Type of 'Type' -> enc_EncryptedData(Val) end
    end;
getenc_Contents(_, _) ->
    fun (_, Val, _RestPrimFieldName) ->
	    Len = case Val of
...
getdec_Contents(id, {1, 2, 840, 113549, 1, 7, 1}) ->
    fun (Type, Bytes, _RestPrimFieldName) ->
	    case Type of 'Type' -> dec_Data(Bytes) end
    end;
getdec_Contents(id, {1, 2, 840, 113549, 1, 7, 2}) ->
    fun (Type, Bytes, _RestPrimFieldName) ->
	    case Type of 'Type' -> dec_SignedData(Bytes) end
    end;
getdec_Contents(id, {1, 2, 840, 113549, 1, 7, 3}) ->
    fun (Type, Bytes, _RestPrimFieldName) ->
	    case Type of 'Type' -> dec_EnvelopedData(Bytes) end
    end;
getdec_Contents(id, {1, 2, 840, 113549, 1, 7, 4}) ->
    fun (Type, Bytes, _RestPrimFieldName) ->
	    case Type of
	      'Type' -> dec_SignedAndEnvelopedData(Bytes)
	    end
    end;
getdec_Contents(id, {1, 2, 840, 113549, 1, 7, 5}) ->
    fun (Type, Bytes, _RestPrimFieldName) ->
	    case Type of 'Type' -> dec_DigestedData(Bytes) end
    end;
getdec_Contents(id, {1, 2, 840, 113549, 1, 7, 6}) ->
    fun (Type, Bytes, _RestPrimFieldName) ->
	    case Type of 'Type' -> dec_EncryptedData(Bytes) end
    end;
getdec_Contents(_, _) ->
    fun (_, Bytes, _RestPrimFieldName) ->
	    case Bytes of
...
%%================================
getenc_DigestEncryptionAlgorithms(_, _) ->
    fun (_, Val, _RestPrimFieldName) ->
	    Len = case Val of
		    Bin when is_binary(Bin) -> size(Bin);
		    _ -> length(Val)
...
getdec_DigestEncryptionAlgorithms(_, _) ->
    fun (_, Bytes, _RestPrimFieldName) ->
	    case Bytes of
	      Bin when is_binary(Bin) -> Bin;
	      _ -> asn1rt_ber_bin_v2__encode(Bytes, nif)
...
%%================================
getenc_ContentEncryptionAlgorithms(_, _) ->
    fun (_, Val, _RestPrimFieldName) ->
	    Len = case Val of
		    Bin when is_binary(Bin) -> size(Bin);
		    _ -> length(Val)
...
getdec_ContentEncryptionAlgorithms(_, _) ->
    fun (_, Bytes, _RestPrimFieldName) ->
	    case Bytes of
	      Bin when is_binary(Bin) -> Bin;
	      _ -> asn1rt_ber_bin_v2__encode(Bytes, nif)
...
%%  SignatureAlgorithms
%%================================
getenc_SignatureAlgorithms(_, _) ->
    fun (_, Val, _RestPrimFieldName) ->
	    Len = case Val of
		    Bin when is_binary(Bin) -> size(Bin);
		    _ -> length(Val)
...
getdec_SignatureAlgorithms(_, _) ->
    fun (_, Bytes, _RestPrimFieldName) ->
	    case Bytes of
	      Bin when is_binary(Bin) -> Bin;
	      _ -> asn1rt_ber_bin_v2__encode(Bytes, nif)
...
%%================================
getenc_internal_object_set_argument_8(id,
				      {1, 2, 840, 113549, 1, 9, 3}) ->
    fun enc_contentType/3;
getenc_internal_object_set_argument_8(id,
				      {1, 2, 840, 113549, 1, 9, 6}) ->
...
getdec_internal_object_set_argument_8(id,
				      {1, 2, 840, 113549, 1, 9, 3}) ->
    fun dec_contentType/3;
getdec_internal_object_set_argument_8(id,
				      {1, 2, 840, 113549, 1, 9, 6}) ->
...
%%================================
getenc_internal_object_set_argument_7(id,
				      {1, 2, 840, 113549, 1, 9, 3}) ->
    fun enc_contentType/3;
getenc_internal_object_set_argument_7(id,
				      {1, 2, 840, 113549, 1, 9, 6}) ->
...
getdec_internal_object_set_argument_7(id,
				      {1, 2, 840, 113549, 1, 9, 3}) ->
    fun dec_contentType/3;
getdec_internal_object_set_argument_7(id,
				      {1, 2, 840, 113549, 1, 9, 6}) ->
...
%%================================
getenc_internal_object_set_argument_5(id,
				      {1, 2, 840, 113549, 1, 9, 3}) ->
    fun enc_contentType/3;
getenc_internal_object_set_argument_5(id,
				      {1, 2, 840, 113549, 1, 9, 4}) ->
...
getenc_internal_object_set_argument_5(id,
				      {1, 2, 840, 113549, 1, 9, 5}) ->
    fun enc_signingTime/3;
getenc_internal_object_set_argument_5(id, ErrV) ->
    fun (C, V, _) ->
	    exit({'Type not compatible with table constraint',
		  {component, C}, {value, V},
		  {unique_name_and_value, id, ErrV}})
...
getdec_internal_object_set_argument_5(id,
				      {1, 2, 840, 113549, 1, 9, 3}) ->
    fun dec_contentType/3;
getdec_internal_object_set_argument_5(id,
				      {1, 2, 840, 113549, 1, 9, 4}) ->
...
getdec_internal_object_set_argument_5(id,
				      {1, 2, 840, 113549, 1, 9, 5}) ->
    fun dec_signingTime/3;
getdec_internal_object_set_argument_5(id, ErrV) ->
    fun (C, V, _) ->
	    exit({{component, C}, {value, V},
		  {unique_name_and_value, id, ErrV}})
    end.
...
%%================================
getenc_internal_object_set_argument_4(id,
				      {1, 2, 840, 113549, 1, 9, 3}) ->
    fun enc_contentType/3;
getenc_internal_object_set_argument_4(id,
				      {1, 2, 840, 113549, 1, 9, 4}) ->
...
getenc_internal_object_set_argument_4(id,
				      {1, 2, 840, 113549, 1, 9, 5}) ->
    fun enc_signingTime/3;
getenc_internal_object_set_argument_4(id, ErrV) ->
    fun (C, V, _) ->
	    exit({'Type not compatible with table constraint',
		  {component, C}, {value, V},
		  {unique_name_and_value, id, ErrV}})
...
getdec_internal_object_set_argument_4(id,
				      {1, 2, 840, 113549, 1, 9, 3}) ->
    fun dec_contentType/3;
getdec_internal_object_set_argument_4(id,
				      {1, 2, 840, 113549, 1, 9, 4}) ->
...
getdec_internal_object_set_argument_4(id,
				      {1, 2, 840, 113549, 1, 9, 5}) ->
    fun dec_signingTime/3;
getdec_internal_object_set_argument_4(id, ErrV) ->
    fun (C, V, _) ->
	    exit({{component, C}, {value, V},
		  {unique_name_and_value, id, ErrV}})
    end.
...
match_tags(Tlv = {Tag, _V}, [T | _Tt]) ->
    exit({error,
	  {asn1, {wrong_tag, {{expected, T}, {got, Tag, Tlv}}}}}).
