...
-asn1_info([{vsn,'3.0.1'},
 ...
 {cwd,"/net/isildur/ldisk/daily_build/17_prebuild_opu_o.2014-06-23_21/otp_src_17/lib/public_key/asn1"},
 {outdir,"/net/isildur/ldisk/daily_build/17_prebuild_opu_o.2014-06-23_21/otp_src_17/lib/public_key/asn1"},
 asn1config,noobj,compact_bit_string,der,
 {i,"."},
 {i,"/net/isildur/ldisk/daily_build/17_prebuild_opu_o.2014-06-23_21/otp_src_17/lib/public_key/asn1"}]}]).
...
[V4|Tlv5] = Tlv4, 
Term4 = begin
binary_to_list(decode_restricted_string(V4, [4]))
end
,
...
[V6|Tlv7] = Tlv6, 
Term6 = begin
binary_to_list(decode_restricted_string(V6, [4]))
end
,
...
begin
binary_to_list(decode_restricted_string(Tlv, [4]))
end
;
...
true;
is_default_4(Value) ->
try check_legacy_named_bitstring(Value, [unclassified], <<1:2>>, 2) of
_ -> true
catch throw:false -> false
end.
