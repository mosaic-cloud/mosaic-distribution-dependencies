%% Generated by the Erlang ASN.1 PER-compiler version, utilizing bit-syntax:3.0.1
...
-asn1_info([{vsn,'3.0.1'},
 ...
 {cwd,"/net/isildur/ldisk/daily_build/17_prebuild_opu_o.2014-06-23_21/otp_src_17/lib/megaco/src/binary"},
 {outdir,"/net/isildur/ldisk/daily_build/17_prebuild_opu_o.2014-06-23_21/otp_src_17/lib/megaco/src/binary"},
 legacy_erlang_types,noobj,
 {i,"."},
 {i,"/net/isildur/ldisk/daily_build/17_prebuild_opu_o.2014-06-23_21/otp_src_17/lib/megaco/src/binary"}]}]).
...
{Term,Remain} = begin
<<V5@V0:2/unsigned-unit:1,V5@Buf1/bitstring>> = Bytes,
V5@Add2 = V5@V0 + 1,
V5@Pad5 = bit_size(V5@Buf1) band 7,
<<_:V5@Pad5,V5@V3:V5@Add2/unsigned-unit:8,V5@Buf4/bitstring>> = V5@Buf1,
{V5@V3,V5@Buf4}
...
<<0:1,V6@V3:4/unsigned-unit:1,V6@Buf4/bitstring>> ->
...
7 -> v91;
8 -> synchISDN;
_ -> exit({error,{asn1,{decode_enumerated,{V6@V3,[v18,v22,v22bis,v32,v32bis,v34,v90,v91,synchISDN]}}}})
end,
{V6@Int5,V6@Buf4};
<<1:1,V6@Buf2/bitstring>> ->
{V6@V3,V6@Buf4} = case V6@Buf2 of
