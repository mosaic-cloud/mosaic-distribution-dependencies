...
%% attribute number 1 with type Externaltypereference1038megaco_per_media_gateway_control_v3NonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference1030megaco_per_media_gateway_control_v3Value
'enc_Value'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3MId
'enc_MId'(Tmpval1)
end,
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3ServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference993megaco_per_media_gateway_control_v3ServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference994megaco_per_media_gateway_control_v3TimeNotation
...
%% attribute number 2 with type Externaltypereference953megaco_per_media_gateway_control_v3ServiceChangeAddress
'enc_ServiceChangeAddress'(Tmpval2)
end,
case ?RT_PER:cindex(4,Val1,serviceChangeVersion) of
asn1_NOVALUE -> [];
...
%% attribute number 4 with type Externaltypereference955megaco_per_media_gateway_control_v3ServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval4)
end,

%% attribute number 5 with type Externaltypereference956megaco_per_media_gateway_control_v3Value
...
%% attribute number 7 with type Externaltypereference969megaco_per_media_gateway_control_v3MId
'enc_MId'(Tmpval6)
end,
...
%% attribute number 8 with type Externaltypereference970megaco_per_media_gateway_control_v3TimeNotation
...
%% attribute number 9 with type Externaltypereference971megaco_per_media_gateway_control_v3NonStandardData
...
%% attribute number 10 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3AuditDescriptor
...
%% attribute number 2 with type Externaltypereference930megaco_per_media_gateway_control_v3DigitMapValue
...
%% attribute number 3 with type Externaltypereference910megaco_per_media_gateway_control_v3NonStandardData
...
%% attribute number 2 with type Externaltypereference891megaco_per_media_gateway_control_v3Value
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3EventDM
'enc_EventDM'(Tmpval3)
end,
...
%% attribute number 3 with type Externaltypereference817megaco_per_media_gateway_control_v3SignalsDescriptor
...
%% attribute number 4 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3NotifyBehaviour
...
%% attribute number 3 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3SecondRequestedActions
...
%% attribute number 2 with type Externaltypereference783megaco_per_media_gateway_control_v3EventDM
'enc_EventDM'(Tmpval3)
end,
...
%% attribute number 3 with type Externaltypereference784megaco_per_media_gateway_control_v3SecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference785megaco_per_media_gateway_control_v3SignalsDescriptor
...
%% attribute number 5 with type Externaltypereference787megaco_per_media_gateway_control_v3NotifyBehaviour
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3SecondEventsDescriptor
...
%% attribute number 2 with type Externaltypereference768megaco_per_media_gateway_control_v3SignalsDescriptor
...
%% attribute number 3 with type Externaltypereference760megaco_per_media_gateway_control_v3RequestedActions
...
%% attribute number 3 with type Externaltypereference731megaco_per_media_gateway_control_v3NonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference613megaco_per_media_gateway_control_v3LocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference614megaco_per_media_gateway_control_v3LocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference615megaco_per_media_gateway_control_v3LocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference617megaco_per_media_gateway_control_v3StatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference608megaco_per_media_gateway_control_v3StreamParms
...
%% attribute number 1 with type Externaltypereference596megaco_per_media_gateway_control_v3TerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference568megaco_per_media_gateway_control_v3TerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference569megaco_per_media_gateway_control_v3ServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference561megaco_per_media_gateway_control_v3TerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference562megaco_per_media_gateway_control_v3ServiceChangeParm
...
%% attribute number 2 with type Externaltypereference547megaco_per_media_gateway_control_v3Value
'enc_Value'(?RT_PER:cindex(3,Val1,value)),
case ?RT_PER:cindex(4,Val1,extraInfo) of
asn1_NOVALUE -> [];
Tmpval1 ->
...
%% attribute number 4 with type Externaltypereference538megaco_per_media_gateway_control_v3TimeNotation
...
%% attribute number 1 with type Externaltypereference522megaco_per_media_gateway_control_v3TerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference523megaco_per_media_gateway_control_v3ErrorDescriptor
...
%% attribute number 1 with type Externaltypereference514megaco_per_media_gateway_control_v3TerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference515megaco_per_media_gateway_control_v3ObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(?RT_PER:cindex(3,Val1,observedEventsDescriptor)),
case ?RT_PER:cindex(4,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference516megaco_per_media_gateway_control_v3ErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
%% attribute number 2 with type Externaltypereference484megaco_per_media_gateway_control_v3IndAudSignal
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3IndAudPropertyGroup
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3PropertyParm
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3IndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3IndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference413megaco_per_media_gateway_control_v3IndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3IndAudStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference406megaco_per_media_gateway_control_v3IndAudStreamParms
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_v3IndAudTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference338megaco_per_media_gateway_control_v3TerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationIDList)),

%% attribute number 2 with type Externaltypereference339megaco_per_media_gateway_control_v3TerminationAudit
...
%% attribute number 1 with type Externaltypereference332megaco_per_media_gateway_control_v3TerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference333megaco_per_media_gateway_control_v3TerminationAudit
'enc_TerminationAudit'(?RT_PER:cindex(3,Val1,terminationAuditResult))].
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference312megaco_per_media_gateway_control_v3TerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference313megaco_per_media_gateway_control_v3AuditDescriptor
...
%% attribute number 3 with type Externaltypereference315megaco_per_media_gateway_control_v3TerminationIDList
...
%% attribute number 1 with type Externaltypereference305megaco_per_media_gateway_control_v3TerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,auditDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference306megaco_per_media_gateway_control_v3AuditDescriptor
...
%% attribute number 1 with type Externaltypereference298megaco_per_media_gateway_control_v3TerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,terminationAudit) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference299megaco_per_media_gateway_control_v3TerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference274megaco_per_media_gateway_control_v3TerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference251megaco_per_media_gateway_control_v3TerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationFrom)),

%% attribute number 2 with type Externaltypereference252megaco_per_media_gateway_control_v3TerminationID
...
%% attribute number 1 with type Externaltypereference215megaco_per_media_gateway_control_v3Command
...
%% attribute number 9 with type Externaltypereference202megaco_per_media_gateway_control_v3SelectLogic
...
%% attribute number 2 with type Externaltypereference166megaco_per_media_gateway_control_v3ErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
...
%% attribute number 3 with type Externaltypereference167megaco_per_media_gateway_control_v3ContextRequest
...
%% attribute number 2 with type Externaltypereference158megaco_per_media_gateway_control_v3ContextRequest
...
%% attribute number 3 with type Externaltypereference159megaco_per_media_gateway_control_v3ContextAttrAuditRequest
...
%% attribute number 2 with type Externaltypereference31megaco_per_media_gateway_control_v3MId
...
%% attribute number 1 with type Externaltypereference10megaco_per_media_gateway_control_v3AuthenticationHeader
'enc_AuthenticationHeader'(Tmpval1)
end,

%% attribute number 2 with type Externaltypereference11megaco_per_media_gateway_control_v3Message
