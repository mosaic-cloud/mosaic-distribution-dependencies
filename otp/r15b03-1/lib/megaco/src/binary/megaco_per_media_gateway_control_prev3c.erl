%% Generated by the Erlang ASN.1 PER-compiler version:1.8
...
%% attribute number 1 with type Externaltypereference1043megaco_per_media_gateway_control_prev3cNonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference1035megaco_per_media_gateway_control_prev3cValue
'enc_Value'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cMId
'enc_MId'(Tmpval1)
end,
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference998megaco_per_media_gateway_control_prev3cServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference999megaco_per_media_gateway_control_prev3cTimeNotation
...
%% attribute number 2 with type Externaltypereference958megaco_per_media_gateway_control_prev3cServiceChangeAddress
'enc_ServiceChangeAddress'(Tmpval2)
end,
case ?RT_PER:cindex(4,Val1,serviceChangeVersion) of
asn1_NOVALUE -> [];
...
%% attribute number 4 with type Externaltypereference960megaco_per_media_gateway_control_prev3cServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval4)
end,

%% attribute number 5 with type Externaltypereference961megaco_per_media_gateway_control_prev3cValue
...
%% attribute number 7 with type Externaltypereference974megaco_per_media_gateway_control_prev3cMId
'enc_MId'(Tmpval6)
end,
...
%% attribute number 8 with type Externaltypereference975megaco_per_media_gateway_control_prev3cTimeNotation
...
%% attribute number 9 with type Externaltypereference976megaco_per_media_gateway_control_prev3cNonStandardData
...
%% attribute number 10 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cAuditDescriptor
...
%% attribute number 2 with type Externaltypereference935megaco_per_media_gateway_control_prev3cDigitMapValue
...
%% attribute number 3 with type Externaltypereference915megaco_per_media_gateway_control_prev3cNonStandardData
...
%% attribute number 2 with type Externaltypereference896megaco_per_media_gateway_control_prev3cValue
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cEventDM
'enc_EventDM'(Tmpval3)
end,
...
%% attribute number 3 with type Externaltypereference822megaco_per_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 4 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cNotifyBehaviour
...
%% attribute number 3 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cSecondRequestedActions
...
%% attribute number 2 with type Externaltypereference788megaco_per_media_gateway_control_prev3cEventDM
'enc_EventDM'(Tmpval3)
end,
...
%% attribute number 3 with type Externaltypereference789megaco_per_media_gateway_control_prev3cSecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference790megaco_per_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 5 with type Externaltypereference792megaco_per_media_gateway_control_prev3cNotifyBehaviour
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cSecondEventsDescriptor
...
%% attribute number 2 with type Externaltypereference773megaco_per_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference765megaco_per_media_gateway_control_prev3cRequestedActions
...
%% attribute number 3 with type Externaltypereference736megaco_per_media_gateway_control_prev3cNonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference618megaco_per_media_gateway_control_prev3cLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference619megaco_per_media_gateway_control_prev3cLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference620megaco_per_media_gateway_control_prev3cLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference622megaco_per_media_gateway_control_prev3cStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference613megaco_per_media_gateway_control_prev3cStreamParms
...
%% attribute number 1 with type Externaltypereference601megaco_per_media_gateway_control_prev3cTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference573megaco_per_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference574megaco_per_media_gateway_control_prev3cServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference566megaco_per_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference567megaco_per_media_gateway_control_prev3cServiceChangeParm
...
%% attribute number 2 with type Externaltypereference552megaco_per_media_gateway_control_prev3cValue
'enc_Value'(?RT_PER:cindex(3,Val1,value)),
case ?RT_PER:cindex(4,Val1,extraInfo) of
asn1_NOVALUE -> [];
Tmpval1 ->
...
%% attribute number 4 with type Externaltypereference543megaco_per_media_gateway_control_prev3cTimeNotation
...
%% attribute number 1 with type Externaltypereference527megaco_per_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference528megaco_per_media_gateway_control_prev3cErrorDescriptor
...
%% attribute number 1 with type Externaltypereference519megaco_per_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference520megaco_per_media_gateway_control_prev3cObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(?RT_PER:cindex(3,Val1,observedEventsDescriptor)),
case ?RT_PER:cindex(4,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference521megaco_per_media_gateway_control_prev3cErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
%% attribute number 2 with type Externaltypereference489megaco_per_media_gateway_control_prev3cIndAudSignal
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cIndAudPropertyGroup
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cPropertyParm
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cIndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cIndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference418megaco_per_media_gateway_control_prev3cIndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cIndAudStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference411megaco_per_media_gateway_control_prev3cIndAudStreamParms
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_media_gateway_control_prev3cIndAudTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference343megaco_per_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationIDList)),

%% attribute number 2 with type Externaltypereference344megaco_per_media_gateway_control_prev3cTerminationAudit
...
%% attribute number 1 with type Externaltypereference337megaco_per_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference338megaco_per_media_gateway_control_prev3cTerminationAudit
'enc_TerminationAudit'(?RT_PER:cindex(3,Val1,terminationAuditResult))].
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference317megaco_per_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference318megaco_per_media_gateway_control_prev3cAuditDescriptor
...
%% attribute number 3 with type Externaltypereference320megaco_per_media_gateway_control_prev3cTerminationIDList
...
%% attribute number 1 with type Externaltypereference310megaco_per_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,auditDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference311megaco_per_media_gateway_control_prev3cAuditDescriptor
...
%% attribute number 1 with type Externaltypereference303megaco_per_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,terminationAudit) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference304megaco_per_media_gateway_control_prev3cTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference279megaco_per_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference256megaco_per_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationFrom)),

%% attribute number 2 with type Externaltypereference257megaco_per_media_gateway_control_prev3cTerminationID
...
%% attribute number 1 with type Externaltypereference220megaco_per_media_gateway_control_prev3cCommand
...
%% attribute number 9 with type Externaltypereference207megaco_per_media_gateway_control_prev3cSelectLogic
...
%% attribute number 2 with type Externaltypereference171megaco_per_media_gateway_control_prev3cErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
...
%% attribute number 3 with type Externaltypereference172megaco_per_media_gateway_control_prev3cContextRequest
...
%% attribute number 2 with type Externaltypereference163megaco_per_media_gateway_control_prev3cContextRequest
...
%% attribute number 3 with type Externaltypereference164megaco_per_media_gateway_control_prev3cContextAttrAuditRequest
...
%% attribute number 2 with type Externaltypereference31megaco_per_media_gateway_control_prev3cMId
...
%% attribute number 1 with type Externaltypereference10megaco_per_media_gateway_control_prev3cAuthenticationHeader
'enc_AuthenticationHeader'(Tmpval1)
end,

%% attribute number 2 with type Externaltypereference11megaco_per_media_gateway_control_prev3cMessage
