...
%% Purpose: encoder and decoder to the types in mod megaco_per_bin_drv_media_gateway_control_v1

-module('megaco_per_bin_drv_media_gateway_control_v1').
-include("megaco_per_bin_drv_media_gateway_control_v1.hrl").
...
%% attribute number 1 with type Externaltypereference950megaco_per_bin_drv_media_gateway_control_v1NonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference945megaco_per_bin_drv_media_gateway_control_v1Value
'enc_Value'(Tmpval2)
end].
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v1MId
'enc_MId'(Tmpval1)
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v1ServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference903megaco_per_bin_drv_media_gateway_control_v1ServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference904megaco_per_bin_drv_media_gateway_control_v1TimeNotation
...
%% attribute number 2 with type Externaltypereference875megaco_per_bin_drv_media_gateway_control_v1ServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference877megaco_per_bin_drv_media_gateway_control_v1ServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval4)
end,

%% attribute number 5 with type Externaltypereference878megaco_per_bin_drv_media_gateway_control_v1Value
...
%% attribute number 7 with type Externaltypereference881megaco_per_bin_drv_media_gateway_control_v1MId
'enc_MId'(Tmpval6)
end,
...
%% attribute number 8 with type Externaltypereference882megaco_per_bin_drv_media_gateway_control_v1TimeNotation
...
%% attribute number 9 with type Externaltypereference883megaco_per_bin_drv_media_gateway_control_v1NonStandardData
...
%% attribute number 3 with type INTEGER
  ...
  begin
  case Tmpval5 of
    Tmpval6 when Tmpval6=<99,Tmpval6>=0 ->
      [10,7,Tmpval6- 0];
    Tmpval6 ->
      exit({error,{value_out_of_bounds,Tmpval6}})
  end
...
%% attribute number 2 with type Externaltypereference857megaco_per_bin_drv_media_gateway_control_v1DigitMapValue
...
%% attribute number 3 with type Externaltypereference837megaco_per_bin_drv_media_gateway_control_v1NonStandardData
...
%% attribute number 2 with type Externaltypereference819megaco_per_bin_drv_media_gateway_control_v1Value
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v1EventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference757megaco_per_bin_drv_media_gateway_control_v1SignalsDescriptor
...
%% attribute number 3 with type Externaltypereference748megaco_per_bin_drv_media_gateway_control_v1SecondRequestedActions
...
%% attribute number 2 with type Externaltypereference721megaco_per_bin_drv_media_gateway_control_v1EventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference722megaco_per_bin_drv_media_gateway_control_v1SecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference723megaco_per_bin_drv_media_gateway_control_v1SignalsDescriptor
...
%% attribute number 3 with type Externaltypereference713megaco_per_bin_drv_media_gateway_control_v1RequestedActions
...
%% attribute number 3 with type Externaltypereference684megaco_per_bin_drv_media_gateway_control_v1NonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference571megaco_per_bin_drv_media_gateway_control_v1LocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference572megaco_per_bin_drv_media_gateway_control_v1LocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference573megaco_per_bin_drv_media_gateway_control_v1LocalRemoteDescriptor
...
%% attribute number 2 with type Externaltypereference566megaco_per_bin_drv_media_gateway_control_v1StreamParms
...
%% attribute number 1 with type Externaltypereference554megaco_per_bin_drv_media_gateway_control_v1TerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference524megaco_per_bin_drv_media_gateway_control_v1TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference525megaco_per_bin_drv_media_gateway_control_v1ServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference517megaco_per_bin_drv_media_gateway_control_v1TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference518megaco_per_bin_drv_media_gateway_control_v1ServiceChangeParm
...
%% attribute number 2 with type Externaltypereference504megaco_per_bin_drv_media_gateway_control_v1Value
'enc_Value'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval3 ->
...
%% attribute number 4 with type Externaltypereference495megaco_per_bin_drv_media_gateway_control_v1TimeNotation
...
%% attribute number 1 with type Externaltypereference479megaco_per_bin_drv_media_gateway_control_v1TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference480megaco_per_bin_drv_media_gateway_control_v1ErrorDescriptor
...
%% attribute number 1 with type Externaltypereference471megaco_per_bin_drv_media_gateway_control_v1TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference472megaco_per_bin_drv_media_gateway_control_v1ObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference473megaco_per_bin_drv_media_gateway_control_v1ErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
?RT_PER:encode_bit_string(no,Tmpval1,[{muxToken,0},{modemToken,1},{mediaToken,2},{eventsToken,3},{signalsToken,4},{digitMapToken,5},{statsToken,6},{observedEventsToken,7},{packagesToken,8},{eventBufferToken,9}])
end].
...
%% attribute number 1 with type Externaltypereference428megaco_per_bin_drv_media_gateway_control_v1TerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference429megaco_per_bin_drv_media_gateway_control_v1TerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference413megaco_per_bin_drv_media_gateway_control_v1TerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference414megaco_per_bin_drv_media_gateway_control_v1AuditDescriptor
...
%% attribute number 1 with type Externaltypereference406megaco_per_bin_drv_media_gateway_control_v1TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference407megaco_per_bin_drv_media_gateway_control_v1AuditDescriptor
...
%% attribute number 1 with type Externaltypereference399megaco_per_bin_drv_media_gateway_control_v1TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference400megaco_per_bin_drv_media_gateway_control_v1TerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference377megaco_per_bin_drv_media_gateway_control_v1TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
...
%% attribute number 1 with type Externaltypereference365megaco_per_bin_drv_media_gateway_control_v1TerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference366megaco_per_bin_drv_media_gateway_control_v1TerminationID
'enc_TerminationID'(element(3,Val1)),

%% attribute number 3 with type ENUMERATED
  begin
  Tmpval2=(case element(4,Val1) of bothway->0;isolate->1;oneway->2;Tmpval1 ->exit({error,{asn1,{enumerated,Tmpval1}}}) end),
  case Tmpval2 of
...
{Term3,Bytes3} =   begin
    {Tmpterm1,Tmpremain1} =
  begin
    {Tmpterm2,Tmpremain2}=?RT_PER:getbits(Bytes2,2),
    {Tmpterm2+0,Tmpremain2}
  end,
...
%% attribute number 1 with type Externaltypereference329megaco_per_bin_drv_media_gateway_control_v1Command
...
%% attribute number 2 with type Externaltypereference306megaco_per_bin_drv_media_gateway_control_v1ErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference307megaco_per_bin_drv_media_gateway_control_v1ContextRequest
...
%% attribute number 2 with type Externaltypereference298megaco_per_bin_drv_media_gateway_control_v1ContextRequest
...
%% attribute number 3 with type Externaltypereference299megaco_per_bin_drv_media_gateway_control_v1ContextAttrAuditRequest
...
%% attribute number 2 with type Externaltypereference185megaco_per_bin_drv_media_gateway_control_v1MId
...
%% attribute number 1 with type Externaltypereference164megaco_per_bin_drv_media_gateway_control_v1AuthenticationHeader
'enc_AuthenticationHeader'(Tmpval1)
end,

%% attribute number 2 with type Externaltypereference165megaco_per_bin_drv_media_gateway_control_v1Message
