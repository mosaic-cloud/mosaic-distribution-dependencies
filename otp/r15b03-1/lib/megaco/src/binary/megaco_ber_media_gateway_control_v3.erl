...
'dec_NotifyBehaviour'/3,
'dec_RegulatedEmbeddedDescriptor'/3,
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:NonStandardIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:Value OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:ServiceChangeAddress OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_v3:ServiceChangeProfile OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 5   External megaco_ber_media_gateway_control_v3:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 5   External megaco_ber_media_gateway_control_v3:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 7   External megaco_ber_media_gateway_control_v3:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 8   External megaco_ber_media_gateway_control_v3:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 9   External megaco_ber_media_gateway_control_v3:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 10   External megaco_ber_media_gateway_control_v3:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:DigitMapValue OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:Value
%%-------------------------------------------------
...
?RT_BER:decode_bit_string(Bytes,[],[{onTimeOut,0},{onInterruptByEvent,1},{onInterruptByNewSignalDescr,2},{otherReason,3},{onIteration,4}],TagIn++[], no_length, OptOrMand).
...
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case ?RT_BER:cindex(6,Val,notifyCompletion) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            ?RT_BER:encode_bit_string([], ?RT_BER:cindex(6,Val,notifyCompletion), [{onTimeOut,0},{onInterruptByEvent,1},{onInterruptByNewSignalDescr,2},{otherReason,3},{onIteration,4}], [{tag,128,4,'IMPLICIT',0}])
       end,
...
%%-------------------------------------------------
   {EncBytes10,EncLen10} =  case ?RT_BER:cindex(11,Val,intersigDelay) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            ?RT_BER:encode_integer([], ?RT_BER:cindex(11,Val,intersigDelay), [{tag,128,9,'IMPLICIT',0}])
       end,
...
%%-------------------------------------------------
   {Term5,Bytes7,Rb6} = case Bytes6 of
<<2:2,_:1,4:5,_/binary>> ->
?RT_BER:decode_bit_string(Bytes6,[],[{onTimeOut,0},{onInterruptByEvent,1},{onInterruptByNewSignalDescr,2},{otherReason,3},{onIteration,4}],[{tag,128,4,'IMPLICIT',0}], no_length, mandatory);
_ ->
{ asn1_NOVALUE, Bytes6, 0 }
end,
...
%%-------------------------------------------------
   {Term10,Bytes12,Rb11} = case Bytes11 of
<<2:2,_:1,9:5,_/binary>> ->
?RT_BER:decode_integer(Bytes11,{0,65535},[{tag,128,9,'IMPLICIT',0}], mandatory);
_ ->
{ asn1_NOVALUE, Bytes11, 0 }
end,

   {Bytes13,Rb12} = ?RT_BER:restbytes2(RemBytes, Bytes12,ext),
   {{'Signal', Term1, Term2, Term3, Term4, Term5, Term6, Term7, Term8, Term9, Term10}, Bytes13, Rb1+Rb2+Rb3+Rb4+Rb5+Rb6+Rb7+Rb8+Rb9+Rb10+Rb11+Rb12}.
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:EventDM OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_v3:NotifyBehaviour OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case ?RT_BER:cindex(5,Val,notifyBehaviour) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            'enc_NotifyBehaviour'(?RT_BER:cindex(5,Val,notifyBehaviour), [{tag,128,3,'EXPLICIT',32}])
       end,

%%-------------------------------------------------
%% attribute number 5 with type NULL OPTIONAL
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case ?RT_BER:cindex(6,Val,resetEventsDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            ?RT_BER:encode_null(?RT_BER:cindex(6,Val,resetEventsDescriptor), [{tag,128,4,'IMPLICIT',0}])
       end,
...
%%-------------------------------------------------
   {Term4,Bytes6,Rb5} = case Bytes5 of
<<2:2,_:1,3:5,_/binary>> ->
'dec_NotifyBehaviour'(Bytes5, opt_or_default, [{tag,128,3,'EXPLICIT',32}]);
_ ->
{ asn1_NOVALUE, Bytes5, 0 }
end,
...
{ asn1_NOVALUE, Bytes6, 0 }
   ...
   {Bytes8,Rb7} = ?RT_BER:restbytes2(RemBytes, Bytes7,ext),
   {{'SecondRequestedActions', Term1, Term2, Term3, Term4, Term5}, Bytes8, Rb1+Rb2+Rb3+Rb4+Rb5+Rb6+Rb7}.
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:SecondRequestedActions OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_v3:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 5   External megaco_ber_media_gateway_control_v3:NotifyBehaviour OPTIONAL
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case ?RT_BER:cindex(6,Val,notifyBehaviour) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            'enc_NotifyBehaviour'(?RT_BER:cindex(6,Val,notifyBehaviour), [{tag,128,4,'EXPLICIT',32}])
       end,

%%-------------------------------------------------
%% attribute number 6 with type NULL OPTIONAL
%%-------------------------------------------------
   {EncBytes6,EncLen6} =  case ?RT_BER:cindex(7,Val,resetEventsDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            ?RT_BER:encode_null(?RT_BER:cindex(7,Val,resetEventsDescriptor), [{tag,128,5,'IMPLICIT',0}])
       end,
...
%%-------------------------------------------------
   {Term5,Bytes7,Rb6} = case Bytes6 of
<<2:2,_:1,4:5,_/binary>> ->
'dec_NotifyBehaviour'(Bytes6, opt_or_default, [{tag,128,4,'EXPLICIT',32}]);
_ ->
{ asn1_NOVALUE, Bytes6, 0 }
end,
...
%%-------------------------------------------------
   {Term6,Bytes8,Rb7} = case Bytes7 of
<<2:2,_:1,5:5,_/binary>> ->
?RT_BER:decode_null(Bytes7,[{tag,128,5,'IMPLICIT',0}], mandatory);
_ ->
{ asn1_NOVALUE, Bytes7, 0 }
end,

   {Bytes9,Rb8} = ?RT_BER:restbytes2(RemBytes, Bytes8,ext),
   {{'RequestedActions', Term1, Term2, Term3, Term4, Term5, Term6}, Bytes9, Rb1+Rb2+Rb3+Rb4+Rb5+Rb6+Rb7+Rb8}.
...
'enc_NotifyBehaviour'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      ...
      notifyRegulated ->
         'enc_RegulatedEmbeddedDescriptor'(element(2,Val), [{tag,128,1,'IMPLICIT',0}]);
      neverNotify ->
...
'dec_NotifyBehaviour'(Bytes, OptOrMand) ->
   'dec_NotifyBehaviour'(Bytes, OptOrMand, []).

'dec_NotifyBehaviour'(Bytes, OptOrMand, TagIn) ->
   {{_,Len},Bytes1, RbExp} = ?RT_BER:check_tags(TagIn++[], Bytes, OptOrMand),
   IndefEndBytes = fun(indefinite,<<0,0,R/binary>>)-> R; (_,B)-> B end,
   IndefEndRb = fun(indefinite,<<0,0,_R/binary>>)-> 2; (_,_)-> 0 end,
   case Bytes1 of
...
%% 'notifyImmediate'
      <<2:2,_:1,0:5,_/binary>> ->
         ...
         {{notifyImmediate, Dec}, IndefEndBytes(Len,Rest), RbExp + RbCho + IndefEndRb(Len,Rest)};


%% 'notifyRegulated'
      <<2:2,_:1,1:5,_/binary>> ->
         {Dec, Rest, RbCho} = 'dec_RegulatedEmbeddedDescriptor'(Bytes1, mandatory, [{tag,128,1,'IMPLICIT',0}]),
         {{notifyRegulated, Dec}, IndefEndBytes(Len,Rest), RbExp + RbCho + IndefEndRb(Len,Rest)};


%% 'neverNotify'
      <<2:2,_:1,2:5,_/binary>> ->
         {Dec, Rest, RbCho} = ?RT_BER:decode_null(Bytes1,[{tag,128,2,'IMPLICIT',0}], mandatory),
         {{neverNotify, Dec}, IndefEndBytes(Len,Rest), RbExp + RbCho + IndefEndRb(Len,Rest)};
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case ?RT_BER:cindex(2,Val,secondEvent) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            'enc_SecondEventsDescriptor'(?RT_BER:cindex(2,Val,secondEvent), [{tag,128,0,'IMPLICIT',0}])
       end,

%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case ?RT_BER:cindex(3,Val,signalsDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            'enc_SignalsDescriptor'(?RT_BER:cindex(3,Val,signalsDescriptor), [{tag,128,1,'IMPLICIT',0}])
       end,
...
'dec_RegulatedEmbeddedDescriptor'(Bytes, OptOrMand) ->
   'dec_RegulatedEmbeddedDescriptor'(Bytes, OptOrMand, []).

'dec_RegulatedEmbeddedDescriptor'(Bytes, OptOrMand, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
   {{_,Len},Bytes1,Rb1} = ?RT_BER:check_tags(TagIn ++ [{tag,0,16,'IMPLICIT',32}], Bytes, OptOrMand), 
...
%%-------------------------------------------------
   {Term1,Bytes3,Rb2} = case Bytes2 of
<<2:2,_:1,0:5,_/binary>> ->
'dec_SecondEventsDescriptor'(Bytes2, opt_or_default, [{tag,128,0,'IMPLICIT',0}]);
_ ->
{ asn1_NOVALUE, Bytes2, 0 }
end,
...
%%-------------------------------------------------
   {Term2,Bytes4,Rb3} = case Bytes3 of
<<2:2,_:1,1:5,_/binary>> ->
'dec_SignalsDescriptor'(Bytes3, opt_or_default, [{tag,128,1,'IMPLICIT',0}]);
_ ->
{ asn1_NOVALUE, Bytes3, 0 }
end,

   {Bytes5,Rb4} = ?RT_BER:restbytes2(RemBytes, Bytes4,ext),
   {{'RegulatedEmbeddedDescriptor', Term1, Term2}, Bytes5, Rb1+Rb2+Rb3+Rb4}.
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:RequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case ?RT_BER:cindex(4,Val,eventAction) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:LocalControlDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_v3:StatisticsDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:StreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:TerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(?RT_BER:cindex(2,Val,terminationID), [{tag,128,0,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:ServiceChangeResult
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:ServiceChangeParm
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_v3:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:ObservedEventsDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_ObservedEventsDescriptor'(?RT_BER:cindex(3,Val,observedEventsDescriptor), [{tag,128,1,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
...
%% attribute number 3 with type INTEGER OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case ?RT_BER:cindex(4,Val,signalRequestID) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            ?RT_BER:encode_integer([], ?RT_BER:cindex(4,Val,signalRequestID), [{tag,128,2,'IMPLICIT',0}])
       end,
...
%%-------------------------------------------------
   {Term3,Bytes5,Rb4} = case Bytes4 of
<<2:2,_:1,2:5,_/binary>> ->
?RT_BER:decode_integer(Bytes4,{0,4294967295},[{tag,128,2,'IMPLICIT',0}], mandatory);
_ ->
{ asn1_NOVALUE, Bytes4, 0 }
end,

   {Bytes6,Rb5} = ?RT_BER:restbytes2(RemBytes, Bytes5,ext),
   {{'IndAudSignal', Term1, Term2, Term3}, Bytes6, Rb1+Rb2+Rb3+Rb4+Rb5}.
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:IndAudSignal OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case ?RT_BER:cindex(5,Val,serviceStateSel) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case ?RT_BER:cindex(5,Val,serviceStateSel) of {_,Enumval3}->Enumval3;_->?RT_BER:cindex(5,Val,serviceStateSel) end) of
test -> ?RT_BER:encode_enumerated(0,[{tag,128,3,'IMPLICIT',0}]);
outOfSvc -> ?RT_BER:encode_enumerated(1,[{tag,128,3,'IMPLICIT',0}]);
inSvc -> ?RT_BER:encode_enumerated(2,[{tag,128,3,'IMPLICIT',0}]);
Enumval4 -> exit({error,{asn1, {enumerated_not_in_range,Enumval4}}})
end
       end,
...
%%-------------------------------------------------
   {Term4,Bytes6,Rb5} = case Bytes5 of
<<2:2,_:1,3:5,_/binary>> ->
?RT_BER:decode_enumerated(Bytes5,[],{[{test,0},{outOfSvc,1},{inSvc,2}],[]},[{tag,128,3,'IMPLICIT',0}], mandatory);
_ ->
{ asn1_NOVALUE, Bytes5, 0 }
end,

   {Bytes7,Rb6} = ?RT_BER:restbytes2(RemBytes, Bytes6,ext),
   {{'IndAudTerminationStateDescriptor', Term1, Term2, Term3, Term4}, Bytes7, Rb1+Rb2+Rb3+Rb4+Rb5+Rb6}.
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:IndAudPropertyGroup
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:PropertyParm OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case ?RT_BER:cindex(3,Val,propertyParms) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            'enc_PropertyParm'(?RT_BER:cindex(3,Val,propertyParms), [{tag,128,1,'IMPLICIT',0}])
       end,
...
%%-------------------------------------------------
   {Term2,Bytes4,Rb3} = case Bytes3 of
<<2:2,_:1,1:5,_/binary>> ->
'dec_PropertyParm'(Bytes3, opt_or_default, [{tag,128,1,'IMPLICIT',0}]);
_ ->
{ asn1_NOVALUE, Bytes3, 0 }
end,

   {Bytes5,Rb4} = ?RT_BER:restbytes2(RemBytes, Bytes4,ext),
   {{'IndAudPropertyParm', Term1, Term2}, Bytes5, Rb1+Rb2+Rb3+Rb4}.
...
%%-------------------------------------------------
%% attribute number 5 with type ENUMERATED OPTIONAL
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case ?RT_BER:cindex(6,Val,streamModeSel) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case ?RT_BER:cindex(6,Val,streamModeSel) of {_,Enumval4}->Enumval4;_->?RT_BER:cindex(6,Val,streamModeSel) end) of
sendOnly -> ?RT_BER:encode_enumerated(0,[{tag,128,4,'IMPLICIT',0}]);
recvOnly -> ?RT_BER:encode_enumerated(1,[{tag,128,4,'IMPLICIT',0}]);
sendRecv -> ?RT_BER:encode_enumerated(2,[{tag,128,4,'IMPLICIT',0}]);
inactive -> ?RT_BER:encode_enumerated(3,[{tag,128,4,'IMPLICIT',0}]);
loopBack -> ?RT_BER:encode_enumerated(4,[{tag,128,4,'IMPLICIT',0}]);
...
%%-------------------------------------------------
   {Term5,Bytes7,Rb6} = case Bytes6 of
<<2:2,_:1,4:5,_/binary>> ->
?RT_BER:decode_enumerated(Bytes6,[],{[{sendOnly,0},{recvOnly,1},{sendRecv,2},{inactive,3},{loopBack,4}],[]},[{tag,128,4,'IMPLICIT',0}], mandatory);
_ ->
{ asn1_NOVALUE, Bytes6, 0 }
end,

   {Bytes8,Rb7} = ?RT_BER:restbytes2(RemBytes, Bytes7,ext),
   {{'IndAudLocalControlDescriptor', Term1, Term2, Term3, Term4, Term5}, Bytes8, Rb1+Rb2+Rb3+Rb4+Rb5+Rb6+Rb7}.
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:IndAudLocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case ?RT_BER:cindex(2,Val,localControlDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case ?RT_BER:cindex(3,Val,localDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case ?RT_BER:cindex(4,Val,remoteDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 4   External megaco_ber_media_gateway_control_v3:IndAudStatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case ?RT_BER:cindex(5,Val,statisticsDescriptor) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:IndAudStreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:IndAudTerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case ?RT_BER:cindex(2,Val,termStateDescr) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%% attribute number 1   External megaco_ber_media_gateway_control_v3:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(?RT_BER:cindex(2,Val,terminationIDList), [{tag,128,0,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:TerminationAudit
%%-------------------------------------------------
...
'dec_TermListAuditResult'(Bytes, OptOrMand) ->
   'dec_TermListAuditResult'(Bytes, OptOrMand, []).

'dec_TermListAuditResult'(Bytes, OptOrMand, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
   {{_,Len},Bytes1,Rb1} = ?RT_BER:check_tags(TagIn ++ [{tag,0,16,'IMPLICIT',32}], Bytes, OptOrMand), 
...
%%-------------------------------------------------
   ...
   {Bytes5,Rb4} = ?RT_BER:restbytes2(RemBytes, Bytes4,ext),
   {{'TermListAuditResult', Term1, Term2}, Bytes5, Rb1+Rb2+Rb3+Rb4}.
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:TerminationID
%%-------------------------------------------------
...
'enc_AuditReply'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      ...
      auditResultTermList ->
         'enc_TermListAuditResult'(element(2,Val), [{tag,128,3,'IMPLICIT',0}]);
      Else -> 
         exit({error,{asn1,{invalid_choice_type,Else}}})
   end,
...
%% 'auditResultTermList'
      <<2:2,_:1,3:5,_/binary>> ->
         {Dec, Rest, RbCho} = 'dec_TermListAuditResult'(Bytes1, mandatory, [{tag,128,3,'IMPLICIT',0}]),
         {{auditResultTermList, Dec}, IndefEndBytes(Len,Rest), RbExp + RbCho + IndefEndRb(Len,Rest)};
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:AuditDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_AuditDescriptor'(?RT_BER:cindex(3,Val,auditDescriptor), [{tag,128,1,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:TerminationIDList OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case ?RT_BER:cindex(4,Val,terminationIDList) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            'enc_TerminationIDList'(?RT_BER:cindex(4,Val,terminationIDList), [{tag,128,2,'IMPLICIT',0}])
       end,
...
%%-------------------------------------------------
   {Term3,Bytes5,Rb4} = case Bytes4 of
<<2:2,_:1,2:5,_/binary>> ->
'dec_TerminationIDList'(Bytes4, opt_or_default, [{tag,128,2,'IMPLICIT',0}]);
_ ->
{ asn1_NOVALUE, Bytes4, 0 }
end,

   {Bytes6,Rb5} = ?RT_BER:restbytes2(RemBytes, Bytes5,ext),
   {{'AuditRequest', Term1, Term2, Term3}, Bytes6, Rb1+Rb2+Rb3+Rb4+Rb5}.
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:TerminationAudit OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:TerminationID
%%-------------------------------------------------
...
%% attribute number 5 with type ENUMERATED OPTIONAL
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case ?RT_BER:cindex(6,Val,topologyDirectionExtension) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case ?RT_BER:cindex(6,Val,topologyDirectionExtension) of {_,Enumval4}->Enumval4;_->?RT_BER:cindex(6,Val,topologyDirectionExtension) end) of
onewayexternal -> ?RT_BER:encode_enumerated(0,[{tag,128,4,'IMPLICIT',0}]);
onewayboth -> ?RT_BER:encode_enumerated(1,[{tag,128,4,'IMPLICIT',0}]);
Enumval5 -> exit({error,{asn1, {enumerated_not_in_range,Enumval5}}})
end
       end,
...
%%-------------------------------------------------
   {Term5,Bytes7,Rb6} = case Bytes6 of
<<2:2,_:1,4:5,_/binary>> ->
?RT_BER:decode_enumerated(Bytes6,[],{[{onewayexternal,0},{onewayboth,1}],[]},[{tag,128,4,'IMPLICIT',0}], mandatory);
_ ->
{ asn1_NOVALUE, Bytes6, 0 }
end,

   {Bytes8,Rb7} = ?RT_BER:restbytes2(RemBytes, Bytes7,ext),
   {{'TopologyRequest', Term1, Term2, Term3, Term4, Term5}, Bytes8, Rb1+Rb2+Rb3+Rb4+Rb5+Rb6+Rb7}.
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:Command
%%-------------------------------------------------
...
'dec_SelectLogic'(Bytes, OptOrMand) ->
   'dec_SelectLogic'(Bytes, OptOrMand, []).

'dec_SelectLogic'(Bytes, OptOrMand, TagIn) ->
   {{_,Len},Bytes1, RbExp} = ?RT_BER:check_tags(TagIn++[], Bytes, OptOrMand),
   IndefEndBytes = fun(indefinite,<<0,0,R/binary>>)-> R; (_,B)-> B end,
   IndefEndRb = fun(indefinite,<<0,0,_R/binary>>)-> 2; (_,_)-> 0 end,
   case Bytes1 of
...
%% 'andAUDITSelect'
      <<2:2,_:1,0:5,_/binary>> ->
         {Dec, Rest, RbCho} = ?RT_BER:decode_null(Bytes1,[{tag,128,0,'IMPLICIT',0}], mandatory),
         {{andAUDITSelect, Dec}, IndefEndBytes(Len,Rest), RbExp + RbCho + IndefEndRb(Len,Rest)};


%% 'orAUDITSelect'
      <<2:2,_:1,1:5,_/binary>> ->
         {Dec, Rest, RbCho} = ?RT_BER:decode_null(Bytes1,[{tag,128,1,'IMPLICIT',0}], mandatory),
         {{orAUDITSelect, Dec}, IndefEndBytes(Len,Rest), RbExp + RbCho + IndefEndRb(Len,Rest)};
...
%% attribute number 6 with type INTEGER OPTIONAL
%%-------------------------------------------------
   {EncBytes6,EncLen6} =  case ?RT_BER:cindex(7,Val,selectpriority) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            ?RT_BER:encode_integer([], ?RT_BER:cindex(7,Val,selectpriority), [{tag,128,5,'IMPLICIT',0}])
       end,

%%-------------------------------------------------
%% attribute number 7 with type BOOLEAN OPTIONAL
%%-------------------------------------------------
   {EncBytes7,EncLen7} =  case ?RT_BER:cindex(8,Val,selectemergency) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            ?RT_BER:encode_boolean(?RT_BER:cindex(8,Val,selectemergency), [{tag,128,6,'IMPLICIT',0}])
       end,

%%-------------------------------------------------
%% attribute number 8 with type BOOLEAN OPTIONAL
%%-------------------------------------------------
   {EncBytes8,EncLen8} =  case ?RT_BER:cindex(9,Val,selectiepscallind) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            ?RT_BER:encode_boolean(?RT_BER:cindex(9,Val,selectiepscallind), [{tag,128,7,'IMPLICIT',0}])
       end,

%%-------------------------------------------------
%% attribute number 9   External megaco_ber_media_gateway_control_v3:SelectLogic OPTIONAL
%%-------------------------------------------------
   {EncBytes9,EncLen9} =  case ?RT_BER:cindex(10,Val,selectLogic) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            'enc_SelectLogic'(?RT_BER:cindex(10,Val,selectLogic), [{tag,128,8,'EXPLICIT',32}])
       end,
...
%%-------------------------------------------------
   {Term6,Bytes8,Rb7} = case Bytes7 of
<<2:2,_:1,5:5,_/binary>> ->
?RT_BER:decode_integer(Bytes7,{0,15},[{tag,128,5,'IMPLICIT',0}], mandatory);
_ ->
{ asn1_NOVALUE, Bytes7, 0 }
end,
...
%%-------------------------------------------------
   {Term7,Bytes9,Rb8} = case Bytes8 of
<<2:2,_:1,6:5,_/binary>> ->
?RT_BER:decode_boolean(Bytes8,[{tag,128,6,'IMPLICIT',0}], mandatory);
_ ->
{ asn1_NOVALUE, Bytes8, 0 }
end,
...
%%-------------------------------------------------
   {Term8,Bytes10,Rb9} = case Bytes9 of
<<2:2,_:1,7:5,_/binary>> ->
?RT_BER:decode_boolean(Bytes9,[{tag,128,7,'IMPLICIT',0}], mandatory);
_ ->
{ asn1_NOVALUE, Bytes9, 0 }
end,
...
%%-------------------------------------------------
   {Term9,Bytes11,Rb10} = case Bytes10 of
<<2:2,_:1,8:5,_/binary>> ->
'dec_SelectLogic'(Bytes10, opt_or_default, [{tag,128,8,'EXPLICIT',32}]);
_ ->
{ asn1_NOVALUE, Bytes10, 0 }
end,

   {Bytes12,Rb11} = ?RT_BER:restbytes2(RemBytes, Bytes11,ext),
   {{'ContextAttrAuditRequest', Term1, Term2, Term3, Term4, Term5, Term6, Term7, Term8, Term9}, Bytes12, Rb1+Rb2+Rb3+Rb4+Rb5+Rb6+Rb7+Rb8+Rb9+Rb10+Rb11}.
...
%%-------------------------------------------------
   {EncBytes6,EncLen6} =  case ?RT_BER:cindex(7,Val,contextList) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            'enc_ContextRequest_contextList'(?RT_BER:cindex(7,Val,contextList), [{tag,128,5,'IMPLICIT',0}])
       end,
...
'dec_ContextRequest_contextList'(Bytes, OptOrMand, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
   {{_,Len},Bytes1,Rb1} = ?RT_BER:check_tags(TagIn ++ [{tag,0,16,'IMPLICIT',32}], Bytes, OptOrMand), 
   ?RT_BER:decode_components(Rb1, Len, Bytes1, fun(FBytes,_,_)->
?RT_BER:decode_integer(FBytes,{0,4294967295},[], mandatory)
end, [], []).
...
%%-------------------------------------------------
   {Term6,Bytes8,Rb7} = case Bytes7 of
<<2:2,_:1,5:5,_/binary>> ->
'dec_ContextRequest_contextList'(Bytes7, opt_or_default, [{tag,128,5,'IMPLICIT',0}]);
_ ->
{ asn1_NOVALUE, Bytes7, 0 }
end,

   {Bytes9,Rb8} = ?RT_BER:restbytes2(RemBytes, Bytes8,ext),
   {{'ContextRequest', Term1, Term2, Term3, Term4, Term5, Term6}, Bytes9, Rb1+Rb2+Rb3+Rb4+Rb5+Rb6+Rb7+Rb8}.
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:ContextRequest OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:ContextRequest OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 3   External megaco_ber_media_gateway_control_v3:ContextAttrAuditRequest OPTIONAL
%%-------------------------------------------------
...
%% attribute number 2 with type INTEGER
%%-------------------------------------------------
   {EncBytes2,EncLen2} = ?RT_BER:encode_integer([], ?RT_BER:cindex(3,Val,segmentNumber), [{tag,128,1,'IMPLICIT',0}]),

%%-------------------------------------------------
%% attribute number 3 with type NULL OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case ?RT_BER:cindex(4,Val,segmentationComplete) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            ?RT_BER:encode_null(?RT_BER:cindex(4,Val,segmentationComplete), [{tag,128,2,'IMPLICIT',0}])
       end,
...
'dec_SegmentReply'(Bytes, OptOrMand) ->
   'dec_SegmentReply'(Bytes, OptOrMand, []).

'dec_SegmentReply'(Bytes, OptOrMand, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
   {{_,Len},Bytes1,Rb1} = ?RT_BER:check_tags(TagIn ++ [{tag,0,16,'IMPLICIT',32}], Bytes, OptOrMand), 
...
%% attribute number 2 with type INTEGER
%%-------------------------------------------------
   {Term2,Bytes4,Rb3} = ?RT_BER:decode_integer(Bytes3,{0,65535},[{tag,128,1,'IMPLICIT',0}], mandatory),
...
{ asn1_NOVALUE, Bytes4, 0 }
   ...
   {Bytes6,Rb5} = ?RT_BER:restbytes2(RemBytes, Bytes5,ext),
   {{'SegmentReply', Term1, Term2, Term3}, Bytes6, Rb1+Rb2+Rb3+Rb4+Rb5}.
...
'enc_Transaction'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      ...
      segmentReply ->
         'enc_SegmentReply'(element(2,Val), [{tag,128,4,'IMPLICIT',0}]);
      Else -> 
         exit({error,{asn1,{invalid_choice_type,Else}}})
   end,
...
%% 'segmentReply'
      <<2:2,_:1,4:5,_/binary>> ->
         {Dec, Rest, RbCho} = 'dec_SegmentReply'(Bytes1, mandatory, [{tag,128,4,'IMPLICIT',0}]),
         {{segmentReply, Dec}, IndefEndBytes(Len,Rest), RbExp + RbCho + IndefEndRb(Len,Rest)};
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:MId
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 1   External megaco_ber_media_gateway_control_v3:AuthenticationHeader OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute number 2   External megaco_ber_media_gateway_control_v3:Message
%%-------------------------------------------------
