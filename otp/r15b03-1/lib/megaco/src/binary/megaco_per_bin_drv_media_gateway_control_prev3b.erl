...
%% Purpose: encoder and decoder to the types in mod megaco_per_bin_drv_media_gateway_control_prev3b

-module('megaco_per_bin_drv_media_gateway_control_prev3b').
-include("megaco_per_bin_drv_media_gateway_control_prev3b.hrl").
...
%% attribute number 1 with type Externaltypereference971megaco_per_bin_drv_media_gateway_control_prev3bNonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference966megaco_per_bin_drv_media_gateway_control_prev3bValue
'enc_Value'(Tmpval2)
end].
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3bMId
'enc_MId'(Tmpval1)
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3bServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference930megaco_per_bin_drv_media_gateway_control_prev3bServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference931megaco_per_bin_drv_media_gateway_control_prev3bTimeNotation
...
%% attribute number 2 with type Externaltypereference890megaco_per_bin_drv_media_gateway_control_prev3bServiceChangeAddress
'enc_ServiceChangeAddress'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 4 with type Externaltypereference892megaco_per_bin_drv_media_gateway_control_prev3bServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval5)
end,

%% attribute number 5 with type Externaltypereference893megaco_per_bin_drv_media_gateway_control_prev3bValue
...
%% attribute number 7 with type Externaltypereference906megaco_per_bin_drv_media_gateway_control_prev3bMId
'enc_MId'(Tmpval7)
end,
...
%% attribute number 8 with type Externaltypereference907megaco_per_bin_drv_media_gateway_control_prev3bTimeNotation
...
%% attribute number 9 with type Externaltypereference908megaco_per_bin_drv_media_gateway_control_prev3bNonStandardData
...
%% attribute number 10 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3bAuditDescriptor
...
%% attribute number 2 with type Externaltypereference867megaco_per_bin_drv_media_gateway_control_prev3bDigitMapValue
...
%% attribute number 3 with type Externaltypereference847megaco_per_bin_drv_media_gateway_control_prev3bNonStandardData
...
%% attribute number 2 with type Externaltypereference827megaco_per_bin_drv_media_gateway_control_prev3bValue
...
?RT_PER:encode_bit_string(no,Tmpval8,[{onTimeOut,0},{onInterruptByEvent,1},{onInterruptByNewSignalDescr,2},{otherReason,3}])
end,
case element(7,Val1) of
asn1_NOVALUE -> [];
Tmpval9 ->
...
case Tmpval1 of
  true -> [1];
  false -> [0];
  _ -> exit({error,{asn1,{encode_boolean,Tmpval1}}})
end
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3bEventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference756megaco_per_bin_drv_media_gateway_control_prev3bSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference747megaco_per_bin_drv_media_gateway_control_prev3bSecondRequestedActions
...
%% attribute number 2 with type Externaltypereference724megaco_per_bin_drv_media_gateway_control_prev3bEventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference725megaco_per_bin_drv_media_gateway_control_prev3bSecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference726megaco_per_bin_drv_media_gateway_control_prev3bSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference716megaco_per_bin_drv_media_gateway_control_prev3bRequestedActions
...
%% attribute number 3 with type Externaltypereference687megaco_per_bin_drv_media_gateway_control_prev3bNonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference569megaco_per_bin_drv_media_gateway_control_prev3bLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference570megaco_per_bin_drv_media_gateway_control_prev3bLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference571megaco_per_bin_drv_media_gateway_control_prev3bLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference573megaco_per_bin_drv_media_gateway_control_prev3bStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference564megaco_per_bin_drv_media_gateway_control_prev3bStreamParms
...
%% attribute number 1 with type Externaltypereference552megaco_per_bin_drv_media_gateway_control_prev3bTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference523megaco_per_bin_drv_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference524megaco_per_bin_drv_media_gateway_control_prev3bServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference516megaco_per_bin_drv_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference517megaco_per_bin_drv_media_gateway_control_prev3bServiceChangeParm
...
%% attribute number 2 with type Externaltypereference502megaco_per_bin_drv_media_gateway_control_prev3bValue
'enc_Value'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval3 ->
...
%% attribute number 4 with type Externaltypereference493megaco_per_bin_drv_media_gateway_control_prev3bTimeNotation
...
%% attribute number 1 with type Externaltypereference477megaco_per_bin_drv_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference478megaco_per_bin_drv_media_gateway_control_prev3bErrorDescriptor
...
%% attribute number 1 with type Externaltypereference469megaco_per_bin_drv_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference470megaco_per_bin_drv_media_gateway_control_prev3bObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference471megaco_per_bin_drv_media_gateway_control_prev3bErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
%% attribute number 2 with type Externaltypereference440megaco_per_bin_drv_media_gateway_control_prev3bIndAudSignal
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3bIndAudPropertyGroup
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3bIndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3bIndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference378megaco_per_bin_drv_media_gateway_control_prev3bIndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3bIndAudStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference371megaco_per_bin_drv_media_gateway_control_prev3bIndAudStreamParms
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_prev3bIndAudTerminationStateDescriptor
...
%% attribute number 1 with type Externaltypereference302megaco_per_bin_drv_media_gateway_control_prev3bTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference303megaco_per_bin_drv_media_gateway_control_prev3bTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference286megaco_per_bin_drv_media_gateway_control_prev3bTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference287megaco_per_bin_drv_media_gateway_control_prev3bAuditDescriptor
...
%% attribute number 1 with type Externaltypereference279megaco_per_bin_drv_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference280megaco_per_bin_drv_media_gateway_control_prev3bAuditDescriptor
...
%% attribute number 1 with type Externaltypereference272megaco_per_bin_drv_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference273megaco_per_bin_drv_media_gateway_control_prev3bTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference248megaco_per_bin_drv_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
...
%% attribute number 1 with type Externaltypereference234megaco_per_bin_drv_media_gateway_control_prev3bTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference235megaco_per_bin_drv_media_gateway_control_prev3bTerminationID
...
%% attribute number 1 with type Externaltypereference198megaco_per_bin_drv_media_gateway_control_prev3bCommand
...
%% attribute number 2 with type Externaltypereference171megaco_per_bin_drv_media_gateway_control_prev3bErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference172megaco_per_bin_drv_media_gateway_control_prev3bContextRequest
...
%% attribute number 2 with type Externaltypereference163megaco_per_bin_drv_media_gateway_control_prev3bContextRequest
...
%% attribute number 3 with type Externaltypereference164megaco_per_bin_drv_media_gateway_control_prev3bContextAttrAuditRequest
...
%% attribute number 2 with type Externaltypereference31megaco_per_bin_drv_media_gateway_control_prev3bMId
...
%% attribute number 1 with type Externaltypereference10megaco_per_bin_drv_media_gateway_control_prev3bAuthenticationHeader
'enc_AuthenticationHeader'(Tmpval1)
end,

%% attribute number 2 with type Externaltypereference11megaco_per_bin_drv_media_gateway_control_prev3bMessage
