...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_v1MId
'enc_MId'(Tmpval1)
end,
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_v1ServiceChangeAddress
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_media_gateway_control_v1EventDM
'enc_EventDM'(Tmpval2)
end,
