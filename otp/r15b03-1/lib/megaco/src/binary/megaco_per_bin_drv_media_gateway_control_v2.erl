...
%% Purpose: encoder and decoder to the types in mod megaco_per_bin_drv_media_gateway_control_v2

-module('megaco_per_bin_drv_media_gateway_control_v2').
-include("megaco_per_bin_drv_media_gateway_control_v2.hrl").
...
%% attribute number 1 with type Externaltypereference936megaco_per_bin_drv_media_gateway_control_v2NonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference931megaco_per_bin_drv_media_gateway_control_v2Value
'enc_Value'(Tmpval2)
end].
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v2MId
'enc_MId'(Tmpval1)
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v2ServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference895megaco_per_bin_drv_media_gateway_control_v2ServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference896megaco_per_bin_drv_media_gateway_control_v2TimeNotation
...
%% attribute number 2 with type Externaltypereference856megaco_per_bin_drv_media_gateway_control_v2ServiceChangeAddress
'enc_ServiceChangeAddress'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 4 with type Externaltypereference858megaco_per_bin_drv_media_gateway_control_v2ServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval5)
end,

%% attribute number 5 with type Externaltypereference859megaco_per_bin_drv_media_gateway_control_v2Value
...
%% attribute number 7 with type Externaltypereference872megaco_per_bin_drv_media_gateway_control_v2MId
'enc_MId'(Tmpval7)
end,
...
%% attribute number 9 with type Externaltypereference874megaco_per_bin_drv_media_gateway_control_v2NonStandardData
...
%% attribute number 10 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v2AuditDescriptor
...
%% attribute number 2 with type Externaltypereference833megaco_per_bin_drv_media_gateway_control_v2DigitMapValue
...
%% attribute number 3 with type Externaltypereference813megaco_per_bin_drv_media_gateway_control_v2NonStandardData
...
%% attribute number 2 with type Externaltypereference793megaco_per_bin_drv_media_gateway_control_v2Value
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v2EventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference732megaco_per_bin_drv_media_gateway_control_v2SignalsDescriptor
...
%% attribute number 3 with type Externaltypereference723megaco_per_bin_drv_media_gateway_control_v2SecondRequestedActions
...
%% attribute number 2 with type Externaltypereference700megaco_per_bin_drv_media_gateway_control_v2EventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference701megaco_per_bin_drv_media_gateway_control_v2SecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference702megaco_per_bin_drv_media_gateway_control_v2SignalsDescriptor
...
%% attribute number 3 with type Externaltypereference692megaco_per_bin_drv_media_gateway_control_v2RequestedActions
...
%% attribute number 3 with type Externaltypereference663megaco_per_bin_drv_media_gateway_control_v2NonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference546megaco_per_bin_drv_media_gateway_control_v2LocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference547megaco_per_bin_drv_media_gateway_control_v2LocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference548megaco_per_bin_drv_media_gateway_control_v2LocalRemoteDescriptor
...
%% attribute number 2 with type Externaltypereference541megaco_per_bin_drv_media_gateway_control_v2StreamParms
...
%% attribute number 1 with type Externaltypereference529megaco_per_bin_drv_media_gateway_control_v2TerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference500megaco_per_bin_drv_media_gateway_control_v2TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference501megaco_per_bin_drv_media_gateway_control_v2ServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference493megaco_per_bin_drv_media_gateway_control_v2TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference494megaco_per_bin_drv_media_gateway_control_v2ServiceChangeParm
...
%% attribute number 2 with type Externaltypereference479megaco_per_bin_drv_media_gateway_control_v2Value
'enc_Value'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval3 ->
...
%% attribute number 4 with type Externaltypereference470megaco_per_bin_drv_media_gateway_control_v2TimeNotation
...
%% attribute number 1 with type Externaltypereference454megaco_per_bin_drv_media_gateway_control_v2TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference455megaco_per_bin_drv_media_gateway_control_v2ErrorDescriptor
...
%% attribute number 1 with type Externaltypereference446megaco_per_bin_drv_media_gateway_control_v2TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference447megaco_per_bin_drv_media_gateway_control_v2ObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference448megaco_per_bin_drv_media_gateway_control_v2ErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
%% attribute number 2 with type Externaltypereference417megaco_per_bin_drv_media_gateway_control_v2IndAudSignal
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v2IndAudPropertyGroup
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v2IndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v2IndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference356megaco_per_bin_drv_media_gateway_control_v2IndAudLocalRemoteDescriptor
...
%% attribute number 2 with type Externaltypereference349megaco_per_bin_drv_media_gateway_control_v2IndAudStreamParms
...
%% attribute number 1 with type Externaltypereferenceundefinedmegaco_per_bin_drv_media_gateway_control_v2IndAudTerminationStateDescriptor
...
%% attribute number 1 with type Externaltypereference280megaco_per_bin_drv_media_gateway_control_v2TerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference281megaco_per_bin_drv_media_gateway_control_v2TerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference264megaco_per_bin_drv_media_gateway_control_v2TerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference265megaco_per_bin_drv_media_gateway_control_v2AuditDescriptor
...
%% attribute number 1 with type Externaltypereference257megaco_per_bin_drv_media_gateway_control_v2TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference258megaco_per_bin_drv_media_gateway_control_v2AuditDescriptor
...
%% attribute number 1 with type Externaltypereference250megaco_per_bin_drv_media_gateway_control_v2TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference251megaco_per_bin_drv_media_gateway_control_v2TerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference227megaco_per_bin_drv_media_gateway_control_v2TerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
...
%% attribute number 1 with type Externaltypereference213megaco_per_bin_drv_media_gateway_control_v2TerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference214megaco_per_bin_drv_media_gateway_control_v2TerminationID
...
%% attribute number 1 with type Externaltypereference177megaco_per_bin_drv_media_gateway_control_v2Command
...
%% attribute number 2 with type Externaltypereference154megaco_per_bin_drv_media_gateway_control_v2ErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference155megaco_per_bin_drv_media_gateway_control_v2ContextRequest
...
%% attribute number 2 with type Externaltypereference146megaco_per_bin_drv_media_gateway_control_v2ContextRequest
...
%% attribute number 3 with type Externaltypereference147megaco_per_bin_drv_media_gateway_control_v2ContextAttrAuditRequest
...
%% attribute number 2 with type Externaltypereference31megaco_per_bin_drv_media_gateway_control_v2MId
...
%% attribute number 1 with type Externaltypereference10megaco_per_bin_drv_media_gateway_control_v2AuthenticationHeader
'enc_AuthenticationHeader'(Tmpval1)
end,

%% attribute number 2 with type Externaltypereference11megaco_per_bin_drv_media_gateway_control_v2Message
