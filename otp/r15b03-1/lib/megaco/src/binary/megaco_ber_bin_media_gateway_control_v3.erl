...
%%-------------------------------------------------
%% attribute nonStandardIdentifier(1)   External megaco_ber_bin_media_gateway_control_v3:NonStandardIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute statValue(2)   External megaco_ber_bin_media_gateway_control_v3:Value OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeMgcId(1)   External megaco_ber_bin_media_gateway_control_v3:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeAddress(2)   External megaco_ber_bin_media_gateway_control_v3:ServiceChangeAddress OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute serviceChangeProfile(4)   External megaco_ber_bin_media_gateway_control_v3:ServiceChangeProfile OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timestamp(5)   External megaco_ber_bin_media_gateway_control_v3:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeReason(5)   External megaco_ber_bin_media_gateway_control_v3:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeMgcId(7)   External megaco_ber_bin_media_gateway_control_v3:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timeStamp(8)   External megaco_ber_bin_media_gateway_control_v3:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute nonStandardData(9)   External megaco_ber_bin_media_gateway_control_v3:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeInfo(10)   External megaco_ber_bin_media_gateway_control_v3:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute digitMapValue(2)   External megaco_ber_bin_media_gateway_control_v3:DigitMapValue OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute nonStandardData(3)   External megaco_ber_bin_media_gateway_control_v3:NonStandardData OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute value(2)   External megaco_ber_bin_media_gateway_control_v3:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute eventDM(2)   External megaco_ber_bin_media_gateway_control_v3:EventDM OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(3)   External megaco_ber_bin_media_gateway_control_v3:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute notifyBehaviour(4)   External megaco_ber_bin_media_gateway_control_v3:NotifyBehaviour OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute eventAction(3)   External megaco_ber_bin_media_gateway_control_v3:SecondRequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute secondEvent(3)   External megaco_ber_bin_media_gateway_control_v3:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(4)   External megaco_ber_bin_media_gateway_control_v3:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute notifyBehaviour(5)   External megaco_ber_bin_media_gateway_control_v3:NotifyBehaviour OPTIONAL
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case Cindex5 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute secondEvent(1)   External megaco_ber_bin_media_gateway_control_v3:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(2)   External megaco_ber_bin_media_gateway_control_v3:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute eventAction(3)   External megaco_ber_bin_media_gateway_control_v3:RequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localControlDescriptor(1)   External megaco_ber_bin_media_gateway_control_v3:LocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localDescriptor(2)   External megaco_ber_bin_media_gateway_control_v3:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute remoteDescriptor(3)   External megaco_ber_bin_media_gateway_control_v3:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute statisticsDescriptor(4)   External megaco_ber_bin_media_gateway_control_v3:StatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute streamParms(2)   External megaco_ber_bin_media_gateway_control_v3:StreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute termStateDescr(1)   External megaco_ber_bin_media_gateway_control_v3:TerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationID(1)   External megaco_ber_bin_media_gateway_control_v3:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute serviceChangeResult(2)   External megaco_ber_bin_media_gateway_control_v3:ServiceChangeResult
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeParms(2)   External megaco_ber_bin_media_gateway_control_v3:ServiceChangeParm
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timeNotation(4)   External megaco_ber_bin_media_gateway_control_v3:TimeNotation OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute errorDescriptor(2)   External megaco_ber_bin_media_gateway_control_v3:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute observedEventsDescriptor(2)   External megaco_ber_bin_media_gateway_control_v3:ObservedEventsDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_ObservedEventsDescriptor'(Cindex2, [<<161>>]),

%%-------------------------------------------------
%% attribute errorDescriptor(3)   External megaco_ber_bin_media_gateway_control_v3:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalList(2)   External megaco_ber_bin_media_gateway_control_v3:IndAudSignal OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute propGrps(2)   External megaco_ber_bin_media_gateway_control_v3:IndAudPropertyGroup
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute propertyParms(2)   External megaco_ber_bin_media_gateway_control_v3:PropertyParm OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localControlDescriptor(1)   External megaco_ber_bin_media_gateway_control_v3:IndAudLocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localDescriptor(2)   External megaco_ber_bin_media_gateway_control_v3:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute remoteDescriptor(3)   External megaco_ber_bin_media_gateway_control_v3:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute statisticsDescriptor(4)   External megaco_ber_bin_media_gateway_control_v3:IndAudStatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute streamParms(2)   External megaco_ber_bin_media_gateway_control_v3:IndAudStreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute termStateDescr(1)   External megaco_ber_bin_media_gateway_control_v3:IndAudTerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationIDList(1)   External megaco_ber_bin_media_gateway_control_v3:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute terminationAuditResult(2)   External megaco_ber_bin_media_gateway_control_v3:TerminationAudit
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute terminationID(1)   External megaco_ber_bin_media_gateway_control_v3:TerminationID
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute auditDescriptor(2)   External megaco_ber_bin_media_gateway_control_v3:AuditDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_AuditDescriptor'(Cindex2, [<<161>>]),

%%-------------------------------------------------
%% attribute terminationIDList(3)   External megaco_ber_bin_media_gateway_control_v3:TerminationIDList OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute auditDescriptor(2)   External megaco_ber_bin_media_gateway_control_v3:AuditDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationAudit(2)   External megaco_ber_bin_media_gateway_control_v3:TerminationAudit OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationFrom(1)   External megaco_ber_bin_media_gateway_control_v3:TerminationID
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationID'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute terminationTo(2)   External megaco_ber_bin_media_gateway_control_v3:TerminationID
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute command(1)   External megaco_ber_bin_media_gateway_control_v3:Command
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute selectLogic(9)   External megaco_ber_bin_media_gateway_control_v3:SelectLogic OPTIONAL
%%-------------------------------------------------
   {EncBytes9,EncLen9} =  case Cindex9 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextReply(3)   External megaco_ber_bin_media_gateway_control_v3:ContextRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextRequest(2)   External megaco_ber_bin_media_gateway_control_v3:ContextRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextAttrAuditReq(3)   External megaco_ber_bin_media_gateway_control_v3:ContextAttrAuditRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute mId(2)   External megaco_ber_bin_media_gateway_control_v3:MId
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute authHeader(1)   External megaco_ber_bin_media_gateway_control_v3:AuthenticationHeader OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute mess(2)   External megaco_ber_bin_media_gateway_control_v3:Message
%%-------------------------------------------------
